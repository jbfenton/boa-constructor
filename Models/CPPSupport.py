...
from Views.StyledTextCtrls import FoldingStyledTextCtrlMix, LanguageSTCMix, stcConfigPath


class CPPStyledTextCtrlMix(LanguageSTCMix):
    def __init__(self, wId):
        LanguageSTCMix.__init__(self, wId, (0, Preferences.STCLineNumMarginWidth), "cpp", stcConfigPath)
        self.setStyles()
...
class CPPSourceView(EditorStyledTextCtrl, CPPStyledTextCtrlMix, FoldingStyledTextCtrlMix):
    ...
    def __init__(self, parent, model):
        EditorStyledTextCtrl.__init__(self, parent, wxID_CPPSOURCEVIEW, model, (), -1)
...
Plugins.registerFileType(CPPController, newName="Cpp", aliasExts=(".cpp", ".c", ".h"))
