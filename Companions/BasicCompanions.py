...
from . import Constructors, EventCollections
...
class ScrollBarDTC(Constructors.MultiItemCtrlsConstr, WindowDTC):
    ...
    def designTimeSource(self, position="wx.DefaultPosition", size="wx.DefaultSize"):
        return {"pos": position, "size": size, "style": "wx.SB_HORIZONTAL", "name": repr(self.name)}

    def events(self):
        return WindowDTC.events(self) + ["ScrollEvent", "CmdScrollEvent"]


EventCategories["ComboEvent"] = ("wx.EVT_COMBOBOX", "wx.EVT_TEXT", "wx.EVT_TEXT_ENTER")
...
class ChoiceDTC(Constructors.ListConstr, ChoicedDTC):
    def designTimeSource(self, position="wx.DefaultPosition", size="wx.DefaultSize"):
        return {"pos": position, "size": size, "choices": repr([]), "style": "0", "name": repr(self.name)}
...
class StaticTextDTC(LabeledNonInputConstr, WindowDTC):
    ...
    def designTimeSource(self, position="wx.DefaultPosition", size="wx.DefaultSize"):
        return {"label": repr(self.name), "pos": position, "size": size, "style": "0", "name": repr(self.name)}


EventCategories["TextCtrlEvent"] = ("wx.EVT_TEXT", "wx.EVT_TEXT_ENTER", "wx.EVT_TEXT_URL", "wx.EVT_TEXT_MAXLEN")
...
class TextCtrlDTC(WindowDTC):
    ...
    def constructor(self):
        return {"Value": "value", "Position": "pos", "Size": "size", "Style": "style", "Name": "name"}

    def designTimeSource(self, position="wx.DefaultPosition", size="wx.DefaultSize"):
        return {"value": repr(self.name), "pos": position, "size": size, "style": "0", "name": repr(self.name)}

    def hideDesignTime(self):
        return WindowDTC.hideDesignTime(self) + ["Selection", "Title", "Label", "DefaultStyle"]
...
class GaugeDTC(WindowDTC):
    ...
    def constructor(self):
        return {"Range": "range", "Position": "pos", "Size": "size", "Style": "style", "Name": "name"}

    def designTimeSource(self, position="wx.DefaultPosition", size="wx.DefaultSize"):
        return {"range": "100", "pos": position, "size": size, "style": "wx.GA_HORIZONTAL", "name": repr(self.name)}
...
class StaticLineDTC(WindowDTC, Constructors.WindowConstr):
    ...
    def designTimeSource(self, position="wx.DefaultPosition", size="wx.DefaultSize"):
        return {"pos": position, "size": size, "style": "0", "name": repr(self.name)}
...
class StaticBitmapDTC(WindowDTC):
    ...
    def constructor(self):
        return {"Bitmap": "bitmap", "Position": "pos", "Size": "size", "Style": "style", "Name": "name"}

    def designTimeSource(self, position="wx.DefaultPosition", size="wx.DefaultSize"):
        return {"bitmap": "wx.NullBitmap", "pos": position, "size": size, "style": "0", "name": repr(self.name)}
...
class HtmlWindowDTC(WindowDTC):
    ...
    def writeImports(self):
        return "\n".join((WindowDTC.writeImports(self), "import wx.html"))
...
stcEOLModeNames = {
    "wx.stc.STC_EOL_CRLF": wx.stc.STC_EOL_CRLF,
...
stcEdgeModeNames = {
    "wx.stc.STC_EDGE_NONE": wx.stc.STC_EDGE_NONE,
...
stcLexerNames = {
    "wx.stc.STC_LEX_NULL": wx.stc.STC_LEX_NULL,
    "wx.stc.STC_LEX_PYTHON": wx.stc.STC_LEX_PYTHON,
    "wx.stc.STC_LEX_CONTAINER": wx.stc.STC_LEX_CONTAINER,
    "wx.stc.STC_LEX_CPP": wx.stc.STC_LEX_CPP,
    "wx.stc.STC_LEX_HTML": wx.stc.STC_LEX_HTML,
    "wx.stc.STC_LEX_XML": wx.stc.STC_LEX_XML,
    "wx.stc.STC_LEX_PERL": wx.stc.STC_LEX_PERL,
    "wx.stc.STC_LEX_SQL": wx.stc.STC_LEX_SQL,
    "wx.stc.STC_LEX_VB": wx.stc.STC_LEX_VB,
    ...
    "wx.stc.STC_LEX_XCODE": wx.stc.STC_LEX_XCODE,
    "wx.stc.STC_LEX_LATEX": wx.stc.STC_LEX_LATEX,
    "wx.stc.STC_LEX_LUA": wx.stc.STC_LEX_LUA,
    "wx.stc.STC_LEX_DIFF": wx.stc.STC_LEX_DIFF,
    "wx.stc.STC_LEX_CONF": wx.stc.STC_LEX_CONF,
    "wx.stc.STC_LEX_PASCAL": wx.stc.STC_LEX_PASCAL,
    "wx.stc.STC_LEX_AVE": wx.stc.STC_LEX_AVE,
    "wx.stc.STC_LEX_ADA": wx.stc.STC_LEX_ADA,
    "wx.stc.STC_LEX_LISP": wx.stc.STC_LEX_LISP,
    "wx.stc.STC_LEX_RUBY": wx.stc.STC_LEX_RUBY,
    "wx.stc.STC_LEX_EIFFEL": wx.stc.STC_LEX_EIFFEL,
    "wx.stc.STC_LEX_EIFFELKW": wx.stc.STC_LEX_EIFFELKW,
    "wx.stc.STC_LEX_TCL": wx.stc.STC_LEX_TCL,
    "wx.stc.STC_LEX_NNCRONTAB": wx.stc.STC_LEX_NNCRONTAB,
...
stcPrintColourModeNames = {
    "wx.stc.STC_PRINT_NORMAL": wx.stc.STC_PRINT_NORMAL,
...
stcWrapModeNames = {"wx.stc.STC_WRAP_NONE": wx.stc.STC_WRAP_NONE, "wx.stc.STC_WRAP_WORD": wx.stc.STC_WRAP_WORD}
...
class StyledTextCtrlDTC(WindowDTC, Constructors.WindowConstr):
    ...
    def designTimeSource(self, position="wx.DefaultPosition", size="wx.DefaultSize"):
        return {"pos": position, "size": self.getDefCtrlSize(), "style": "0", "name": repr(self.name)}
    ...
    def writeImports(self):
        return "\n".join((WindowDTC.writeImports(self), "import wx.stc"))
...
class FilenameConstrPropEdit(ConstrPropEdit):
    ...
    def edit(self, event):
        dlg = wx.FileDialog(self.parent, self.dlgCaption, ".", self.value, self.fileTypeFilter, wx.FD_OPEN)
        try:
...
class GIFAnimationCtrlDTC(WindowDTC):
    ...
    def constructor(self):
        return {"Position": "pos", "Size": "size", "Name": "name", "Style": "style", "Filename": "filename"}
    ...
    def writeImports(self):
        return "\n".join((WindowDTC.writeImports(self), "import wx.adv.Animation"))
...
class MediaCtrlDTC(WindowDTC):
    ...
    def writeImports(self):
        return "\n".join((WindowDTC.writeImports(self), "import wx.media"))
...
class RichTextCtrlDTC(WindowDTC):
    ...
    def constructor(self):
        return {"Value": "value", "Position": "pos", "Size": "size", "Style": "style"}
    ...
    def writeImports(self):
        return "\n".join((WindowDTC.writeImports(self), "import wx.richtext"))
    ...
    def properties(self):
        ...
        props = WindowDTC.properties(self)
        props.update(
            {"Editable": ("CtrlRoute", wx.richtext.RichTextCtrl.IsEditable, wx.richtext.RichTextCtrl.SetEditable)}
        )
        return props
...
class ComboCtrlDTC(WindowDTC):
    def __init__(self, name, designer, parent, ctrlClass):
        ...
        self.windowStyles = [
            ...
            "wx.CB_SORT",
            "wx.TE_PROCESS_ENTER",
            "wx.combo.CC_SPECIAL_DCLICK",
            "wx.combo.CC_STD_BUTTON",
        ] + self.windowStyles
    ...
    def writeImports(self):
        return "\n".join((WindowDTC.writeImports(self), "import wx.combo"))
...
class BitmapComboBoxItemsCDTC(CollectionDTC):
    ...
    def __init__(self, name, designer, parentCompanion, ctrl):
        ...
        self.editors = {"Position": IntConstrPropEdit, "Item": StrConstrPropEdit, "Bitmap": BitmapConstrPropEdit}
    ...
    def designTimeSource(self, wId, method=None):
        return {"pos": repr(wId), "item": repr("%s%d" % (self.propName, wId)), "bitmap": "wx.NullBitmap"}
        ...
        props.update(
            {
                "SearchButtonVisible": (
                    "CtrlRoute",
                    wx.SearchCtrl.IsSearchButtonVisible,
                    wx.SearchCtrl.ShowSearchButton,
                ),
                "CancelButtonVisible": (
                    "CtrlRoute",
                    wx.SearchCtrl.IsCancelButtonVisible,
                    wx.SearchCtrl.ShowCancelButton,
                ),
            }
        )
        return props
