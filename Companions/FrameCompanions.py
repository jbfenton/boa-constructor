...
class FramesConstr(Constructors.PropertyKeywordConstructor):
    def constructor(self):
        ...
        return {"Title": "title", "Position": "pos", "Size": "size", "Style": "style", "Name": "name", "Text": "text"}
...
class FrameDTC(FramesConstr, BaseFrameDTC):
    def __init__(self, name, designer, frameCtrl):
        ...
        self.editors.update(
            {
                "StatusBar": StatusBarClassLinkPropEdit,
    ...
    def dependentProps(self):
        return BaseFrameDTC.dependentProps(self) + ["ToolBar", "MenuBar", "StatusBar"]
...
class DialogDTC(FramesConstr, BaseFrameDTC):
    ...
    def hideDesignTime(self):
        ...
        return BaseFrameDTC.hideDesignTime(self) + ["ToolBar", "MenuBar", "StatusBar", "StatusBarPane"]
...
class FramePanelDTC(BaseFrameDTC, Constructors.WindowConstr):
    ...
    def hideDesignTime(self):
        return BaseFrameDTC.hideDesignTime(self) + [
            "ToolBar",
            "MenuBar",
            "StatusBar",
            "StatusBarPane",
