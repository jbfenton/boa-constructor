...
class ComCtrlDTC(WindowDTC):
    ...
    def writeImports(self):
        return "\n".join(
            (WindowDTC.writeImports(self), "from wx.lib.bcrtl.activex.%s import %s" % (self.comModule, self.comImports))
        )
...
try:
    ...
    EventCategories["WebBrowserEvent"] = (
        EVT_CWB_BEFORENAVIGATE,
        EVT_CWB_TITLECHANGE,
        EVT_CWB_DOWNLOADBEGIN,
        EVT_CWB_PROPERTYCHANGE,
        EVT_CWB_COMMANDSTATECHANGE,
        EVT_CWB_FRAMEBEFORENAVIGATE,
        EVT_CWB_WINDOWACTIVATE,
        EVT_CWB_NEWWINDOW,
        EVT_CWB_DOWNLOADCOMPLETE,
        EVT_CWB_WINDOWRESIZE,
        EVT_CWB_WINDOWMOVE,
        EVT_CWB_PROGRESSCHANGE,
        EVT_CWB_FRAMENEWWINDOW,
        EVT_CWB_STATUSTEXTCHANGE,
        EVT_CWB_FRAMENAVIGATECOMPLETE,
        EVT_CWB_QUIT,
        EVT_CWB_NAVIGATECOMPLETE,
    )
