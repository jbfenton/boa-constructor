...
class FontDTC(HelperDTC):
    def __init__(self, name, designer, cmpn, obj, ownerPW):
        ...
        self.editors = {
            "FaceName": PropertyEditors.EnumPropEdit,
    ...
    def hideDesignTime(self):
        return HelperDTC.hideDesignTime(self) + [
            "Encoding",
            "NativeFontInfo",
...
class ColourDTC(HelperDTC):
    ...
    def properties(self):
        return {
            "Red": ("CompnRoute", self.GetRed, self.SetRed),
...
class PosDTC(HelperDTC):
    def __init__(self, name, designer, cmpn, obj, ownerPW):
        HelperDTC.__init__(self, name, designer, cmpn, obj, ownerPW)
        self.editors = {"X": PropertyEditors.IntPropEdit, "Y": PropertyEditors.IntPropEdit}

    def properties(self):
        return {"X": ("CompnRoute", self.GetX, self.SetX), "Y": ("CompnRoute", self.GetY, self.SetY)}
...
class SizeDTC(HelperDTC):
    def __init__(self, name, designer, cmpn, obj, ownerPW):
        HelperDTC.__init__(self, name, designer, cmpn, obj, ownerPW)
        self.editors = {"Width": PropertyEditors.IntPropEdit, "Height": PropertyEditors.IntPropEdit}

    def properties(self):
        return {
            "Width": ("CompnRoute", self.GetWidth, self.SetWidth),
...
class AnchorsDTC(HelperDTC):
    def __init__(self, name, designer, cmpn, obj, ownerPW):
        HelperDTC.__init__(self, name, designer, cmpn, obj, ownerPW)
        self.editors = {
            "Left": PropertyEditors.BoolPropEdit,
    ...
    def properties(self):
        return {
            "Left": ("CompnRoute", self.GetLeftAnchor, self.SetLeftAnchor),
...
PaletteStore.helperClasses.update({"wx.Font": FontDTC, "wx.Colour": ColourDTC, "Anchors": AnchorsDTC})
