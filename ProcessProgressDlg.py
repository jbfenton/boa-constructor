...
[
    wxID_PROCESSPROGRESSDLG,
    wxID_PROCESSPROGRESSDLGCANCELBTN,
    wxID_PROCESSPROGRESSDLGCMDSTXT,
    wxID_PROCESSPROGRESSDLGERRORTCTRL,
    wxID_PROCESSPROGRESSDLGKILLBTN,
    wxID_PROCESSPROGRESSDLGOUTPUTTCTRL,
    wxID_PROCESSPROGRESSDLGSPLITTERWINDOW,
    wxID_PROCESSPROGRESSDLGSTATUSGGE,
...
class ProcessProgressDlg(wx.Dialog, ProcessRunnerMix):
    def _init_ctrls(self, prnt):
        ...
        self.cancelBtn.Bind(wx.EVT_BUTTON, self.OnCancelbtnButton, id=wxID_PROCESSPROGRESSDLGCANCELBTN)

        self.cmdStxt = wx.StaticText(
            id=wxID_PROCESSPROGRESSDLGCMDSTXT,
            label="staticText1",
            name="cmdStxt",
            parent=self,
            pos=wx.Point(8, 8),
        ...
        self.splitterWindow.SetConstraints(LayoutAnchors(self.splitterWindow, True, True, True, True))

        self.errorTctrl = wx.TextCtrl(
            id=wxID_PROCESSPROGRESSDLGERRORTCTRL,
            name="errorTctrl",
        ...
        self.outputTctrl = wx.TextCtrl(
            id=wxID_PROCESSPROGRESSDLGOUTPUTTCTRL,
            name="outputTctrl",
            parent=self.splitterWindow,
            pos=wx.Point(0, 87),
        ...
        self.splitterWindow.SplitHorizontally(self.errorTctrl, self.outputTctrl, 80)

        self.statusStxt = wx.StaticText(
            id=wxID_PROCESSPROGRESSDLGSTATUSSTXT,
            label="staticText1",
            name="statusStxt",
            parent=self,
            pos=wx.Point(8, 288),
        ...
        self.statusGge = wx.Gauge(
            id=wxID_PROCESSPROGRESSDLGSTATUSGGE,
            name="statusGge",
            parent=self,
            pos=wx.Point(8, 312),
            range=100,
        ...
        self.killBtn.SetConstraints(LayoutAnchors(self.killBtn, False, False, True, True))
        self.killBtn.Enable(False)
        self.killBtn.Bind(wx.EVT_BUTTON, self.OnKillbtnButton, id=wxID_PROCESSPROGRESSDLGKILLBTN)
