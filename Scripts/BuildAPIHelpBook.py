...
def build_contents():
    ...
    hhc = (
        ...
        + "<UL>"
        + os.linesep
        + entry_hhx % ("wx-module.html", "Submodules")
        + "".join(submodules)
        + "</UL>"
        + os.linesep
        + "<UL>"
        + os.linesep
        + entry_hhx % ("trees.html", "Class Hierarchy")
...
def build_keywords():
    ...
    hhk = header_hhx + "<UL>" + os.linesep + "".join([entry_hhx % (u, k) for u, k in p.indices]) + os.linesep + "</UL>"
