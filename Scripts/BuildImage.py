            ...
            for txtEntry in txtEntries:
                ...
                if txtEntry:
                    if txtEntry == "D":
                        ...
                        copyFilePath(os.path.join(srcFilepath, dirName), os.path.join(dstFilepath, dirName))
                    else:
                        try:
                            ...
                            try:
                                ...
                                pass
                            shutil.copy(os.path.join(srcFilepath, filename), os.path.join(dstFilepath, filename))
                        except IOError:
