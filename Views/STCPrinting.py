...
[
    wxID_STCPRINTDLG,
    wxID_STCPRINTDLGBTNCANCEL,
    wxID_STCPRINTDLGBTNPRINT,
    wxID_STCPRINTDLGBTNPRINTPREVIEW,
    wxID_STCPRINTDLGBTNPRINTSETUP,
    wxID_STCPRINTDLGCKBFILENAME,
    wxID_STCPRINTDLGCKBPAGENUMBERS,
...
class STCPrintDlg(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(
            ...
            name="STCPrintDlg",
            parent=prnt,
            pos=wx.Point(352, 204),
            size=wx.Size(402, 189),
            style=wx.DEFAULT_DIALOG_STYLE,
            title=_("Print Source"),
        )
        ...
        self.rdbColourMode = wx.RadioBox(
            choices=[_("Normal"), _("Black on white"), _("Colour on white"), _("Colour on white default background")],
            id=wxID_STCPRINTDLGRDBCOLOURMODE,
            label=_("Colour Mode"),
            majorDimension=1,
            name="rdbColourMode",
            parent=self,
            pos=wx.Point(8, 8),
            size=wx.Size(216, 112),
            style=wx.RA_SPECIFY_COLS,
        )

        self.ckbFilename = wx.CheckBox(
            id=wxID_STCPRINTDLGCKBFILENAME,
            label=_("Filename at top"),
            name="ckbFilename",
            parent=self,
            pos=wx.Point(240, 16),
            size=wx.Size(144, 13),
        ...
        self.ckbPageNumbers = wx.CheckBox(
            id=wxID_STCPRINTDLGCKBPAGENUMBERS,
        ...
        self.btnPrintSetup.Bind(wx.EVT_BUTTON, self.OnPrintSetup, id=wxID_STCPRINTDLGBTNPRINTSETUP)

        self.btnPrintPreview = wx.Button(
            id=wxID_STCPRINTDLGBTNPRINTPREVIEW,
            label=_("Print Preview"),
            name="btnPrintPreview",
            parent=self,
            pos=wx.Point(104, 128),
            size=wx.Size(88, 23),
            style=0,
        )
        self.btnPrintPreview.Bind(wx.EVT_BUTTON, self.OnPrintPreview, id=wxID_STCPRINTDLGBTNPRINTPREVIEW)

        self.btnPrint = wx.Button(
        ...
        self.btnPrint.Bind(wx.EVT_BUTTON, self.OnDoPrint, id=wxID_STCPRINTDLGBTNPRINT)
...
class STCPrintout(wx.Printout):
    ...
    def OnPrintPage(self, page):
        ...
        if self.doPageNums:
            ...
            dc.DrawText(pageLabel, int(dw / scale / 2 - plw / 2), int((textAreaHeight + mh) / scale + plh * 2))
        ...
        ep = stc.FormatRange(
            ...
            wx.Rect(
                0, (page - 1) * self.linesPerPage * self.stcLineHeight, maxWidth, self.stcLineHeight * self.linesPerPage
            ),
        )
        ...
        if not self.IsPreview():
            if ep < stcEndPos:
                print("warning: on page %s: not enough chars rendered, diff: %s" % (page, stcEndPos - ep))
