...
[
    wxID_CREATIONORDERDLG,
    wxID_CREATIONORDERDLGBBDOWN,
    wxID_CREATIONORDERDLGBBDOWNLAST,
    wxID_CREATIONORDERDLGBBUP,
    wxID_CREATIONORDERDLGBBUPFIRST,
    wxID_CREATIONORDERDLGBTCANCEL,
    wxID_CREATIONORDERDLGBTOK,
    wxID_CREATIONORDERDLGCONTEXTHELPBUTTON1,
    wxID_CREATIONORDERDLGLBOBJECTS,
    wxID_CREATIONORDERDLGPANEL1,
...
class CreationOrderDlg(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(
            self,
            id=wxID_CREATIONORDERDLG,
            name="CreationOrderDlg",
            parent=prnt,
            pos=wx.Point(396, 265),
            size=wx.Size(280, 281),
        ...
        self.panel1 = wx.Panel(
            id=wxID_CREATIONORDERDLGPANEL1,
            name="panel1",
            parent=self,
            pos=wx.Point(1, 1),
            size=wx.Size(270, 252),
            style=wx.TAB_TRAVERSAL,
        )
        self.panel1.SetHelpText(
            _(
                "This dialog manages the order of controls on the level (share a parent). "
                "When the parent is recreated, the objects will be recreated in the new order."
            )
        )

        self.staticBox1 = wx.StaticBox(
            id=wxID_CREATIONORDERDLGSTATICBOX1,
            label=_("Current creation/tab order"),
            name="staticBox1",
            parent=self.panel1,
            pos=wx.Point(8, 0),
            size=wx.Size(256, 208),
            style=0,
        )

        self.lbObjects = wx.ListBox(
            choices=[],
            id=wxID_CREATIONORDERDLGLBOBJECTS,
            name="lbObjects",
            parent=self.panel1,
            pos=wx.Point(16, 16),
            size=wx.Size(200, 184),
            style=wx.LB_EXTENDED,
        )

        self.bbUpFirst = wx.BitmapButton(
            bitmap=self.bmpUpFirst,
        ...
        self.bbUpFirst.Bind(wx.EVT_BUTTON, self.OnBbUpFirstButton, id=wxID_CREATIONORDERDLGBBUPFIRST)

        self.bbUp = wx.BitmapButton(
            bitmap=self.bmpUp,
        ...
        self.bbUp.Bind(wx.EVT_BUTTON, self.OnBbupButton, id=wxID_CREATIONORDERDLGBBUP)
        ...
        self.bbDown = wx.BitmapButton(
            ...
            name="bbDown",
            parent=self.panel1,
            pos=wx.Point(224, 104),
            size=wx.Size(24, 24),
            style=wx.BU_AUTODRAW,
        )
        self.bbDown.Bind(wx.EVT_BUTTON, self.OnBbdownButton, id=wxID_CREATIONORDERDLGBBDOWN)

        self.bbDownLast = wx.BitmapButton(
            bitmap=self.bmpDownLast,
            id=wxID_CREATIONORDERDLGBBDOWNLAST,
            name="bbDownLast",
            parent=self.panel1,
            pos=wx.Point(224, 136),
            size=wx.Size(24, 24),
            style=wx.BU_AUTODRAW,
        )
        self.bbDownLast.Bind(wx.EVT_BUTTON, self.OnBbDownLastButton, id=wxID_CREATIONORDERDLGBBDOWNLAST)
        ...
        self.btOK = wx.Button(
            ...
            name="btOK",
            parent=self.panel1,
            pos=wx.Point(112, 224),
            size=wx.Size(72, 24),
            style=0,
        )
        self.btOK.Bind(wx.EVT_BUTTON, self.OnBtokButton, id=wxID_CREATIONORDERDLGBTOK)
        ...
        self.btCancel.Bind(wx.EVT_BUTTON, self.OnBtcancelButton, id=wxID_CREATIONORDERDLGBTCANCEL)

        self.contextHelpButton1 = wx.ContextHelpButton(
            parent=self.panel1, pos=wx.Point(8, 229), size=wx.Size(20, 19), style=wx.BU_AUTODRAW
        )
    ...
    def OnBbUpFirstButton(self, event):
        ...
        if not selItems or selItems[0] < 1:
            return
    ...
    def OnBbdownButton(self, event):
        selItems = self.lbObjects.GetSelections()
        cnt = len(selItems)
        if not selItems or selItems[cnt - 1] > (len(self.ctrlNames) - 2):
            return
        for i in range(cnt):
...
if __name__ == "__main__":
    ...
    dlg = CreationOrderDlg(
        None,
        [(0, "ctrl1"), (1, "ctrl2"), (5, "ctrl3")],
