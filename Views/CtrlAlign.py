...
class ControlAlignmentFrame(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        self.panel1 = wx.Panel(
            id=wxID_CONTROLALIGNMENTFRAMEPANEL1,
            name="panel1",
            parent=self,
            pos=wx.Point(0, 0),
        ...
        self.radioBox1 = wx.RadioBox(
            choices=[_("No change"), _("Left sides"), _("Centers"), _("Right sides"), _("Space equally")],
        ...
        self.okBtn.Bind(wx.EVT_BUTTON, self.OnOkbtnButton, id=wxID_CONTROLALIGNMENTFRAMEOKBTN)
        ...
        self.cancelBtn.Bind(wx.EVT_BUTTON, self.OnCancelbtnButton, id=wxID_CONTROLALIGNMENTFRAMECANCELBTN)

        self.radioBox2 = wx.RadioBox(
            choices=[_("No change"), _("Tops"), _("Centers"), _("Bottoms"), _("Space equally")],
        ...
        for sel in self.selection:
            ...
            if self.choices[hor] == _("Left sides"):
                ...
                if sel != firstSel and sel != lastSel:
                    domove = True
                    newX = (lastSelPos.x - firstSelPos.x) / (selSize - 1) * selIdx + firstSelPos.x
            ...
            if self.choices[ver] == _("Tops"):
                ...
                if sel != firstSel and sel != lastSel:
                    domove = True
                    newY = (lastSelPos.y - firstSelPos.y) / (selSize - 1) * selIdx + firstSelPos.y
