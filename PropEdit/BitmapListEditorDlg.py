...
[
    wxID_BITMAPLISTEDITORDLG,
    wxID_BITMAPLISTEDITORDLGBUTTON6,
    wxID_BITMAPLISTEDITORDLGBUTTON7,
    wxID_BITMAPLISTEDITORDLGBUTTONADD,
    wxID_BITMAPLISTEDITORDLGBUTTONEDIT,
    wxID_BITMAPLISTEDITORDLGBUTTONMOVEDOWN,
    wxID_BITMAPLISTEDITORDLGBUTTONMOVEUP,
    wxID_BITMAPLISTEDITORDLGBUTTONREMOVE,
...
class BitmapListEditorDlg(wx.Dialog):
    ...
    def _init_coll_boxSizer1_Items(self, parent):
        ...
        parent.AddSizer(self.boxSizer3, 0, border=16, flag=wx.RIGHT | wx.LEFT | wx.BOTTOM | wx.ALIGN_RIGHT)
    ...
    def _init_coll_boxSizer2_Items(self, parent):
        ...
        parent.AddSizer(self.boxSizer4, 0, border=0, flag=wx.ALIGN_CENTER_VERTICAL)

    def _init_coll_listCtrl_Columns(self, parent):
        # generated method, don't edit

        parent.InsertColumn(col=0, format=wx.LIST_FORMAT_LEFT, heading="Source", width=320)
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(
            self,
            id=wxID_BITMAPLISTEDITORDLG,
            name="BitmapListEditorDlg",
            parent=prnt,
            pos=wx.Point(581, 347),
        ...
        self.listCtrl.Bind(
            wx.EVT_LIST_ITEM_SELECTED, self.OnListCtrlListItemSelected, id=wxID_BITMAPLISTEDITORDLGLISTCTRL
        )
        ...
        self.buttonAdd.Bind(wx.EVT_BUTTON, self.OnButtonAddButton, id=wxID_BITMAPLISTEDITORDLGBUTTONADD)
        ...
        self.buttonRemove = wx.Button(
            ...
            name="buttonRemove",
            parent=self,
            pos=wx.Point(366, 110),
            size=wx.Size(75, 23),
            style=0,
        )
        self.buttonRemove.Bind(wx.EVT_BUTTON, self.OnButtonRemoveButton, id=wxID_BITMAPLISTEDITORDLGBUTTONREMOVE)

        self.buttonEdit = wx.Button(
            id=wxID_BITMAPLISTEDITORDLGBUTTONEDIT,
            label=_("Edit"),
            name="buttonEdit",
            parent=self,
            pos=wx.Point(366, 141),
            size=wx.Size(75, 23),
            style=0,
        )
        self.buttonEdit.Bind(wx.EVT_BUTTON, self.OnButtonEditButton, id=wxID_BITMAPLISTEDITORDLGBUTTONEDIT)
        ...
        self.buttonMoveUp = wx.Button(
            ...
            name="buttonMoveUp",
            parent=self,
            pos=wx.Point(366, 172),
            size=wx.Size(75, 23),
            style=0,
        )
        self.buttonMoveUp.Bind(wx.EVT_BUTTON, self.OnButtonMoveUpButton, id=wxID_BITMAPLISTEDITORDLGBUTTONMOVEUP)
        ...
        self.buttonMoveDown = wx.Button(
            ...
            name="buttonMoveDown",
            parent=self,
            pos=wx.Point(366, 203),
            size=wx.Size(75, 23),
            style=0,
        )
        self.buttonMoveDown.Bind(wx.EVT_BUTTON, self.OnButtonMoveDownButton, id=wxID_BITMAPLISTEDITORDLGBUTTONMOVEDOWN)

        self.button6 = wx.Button(
            id=wx.ID_OK,
            label=_("OK"),
            name="button6",
            parent=self,
            pos=wx.Point(283, 305),
            size=wx.Size(75, 23),
            style=0,
        )

        self.button7 = wx.Button(
            id=wx.ID_CANCEL,
            label=_("Cancel"),
            name="button7",
            parent=self,
            pos=wx.Point(366, 305),
            size=wx.Size(75, 23),
            style=0,
        )
    ...
    def OnButtonAddButton(self, event):
        ...
        if self.width == -1 and self.height == -1:
            ...
            wx.LogError(
                _("Size mismatch, all images must have the same size (%s, %s), not (%s, %s)")
                % (self.width, self.height, bmp.GetWidth(), bmp.GetHeight())
            )
            return
    ...
    def OnButtonEditButton(self, event):
        if self.selection != -1:
            ...
            if self.width != bmp.GetWidth() or self.height != bmp.GetHeight():
                wx.LogError(_("Size mismatch, all images must have the same size (%s, %s)") % (self.width, self.height))
                return
