...
[
    wxID_FLEXGRIDGROWABLESDLG,
    wxID_FLEXGRIDGROWABLESDLGBUTTON1,
    wxID_FLEXGRIDGROWABLESDLGBUTTON2,
    wxID_FLEXGRIDGROWABLESDLGBUTTON3,
...
class FlexGridGrowablesDlg(wx.Dialog):
    ...
    def _init_coll_boxSizer2_Items(self, parent):
        ...
        parent.Add(self.button3, 0, border=20, flag=wx.ALL)
        parent.Add(self.button1, 0, border=20, flag=wx.RIGHT | wx.TOP | wx.BOTTOM)
        parent.Add(self.button2, 0, border=20, flag=wx.RIGHT | wx.TOP | wx.BOTTOM)

    def _init_sizers(self):
        # generated method, don't edit
        self.boxSizer1 = wx.BoxSizer(orient=wx.VERTICAL)

        self.flex = wx.FlexGridSizer(cols=self.numCols, hgap=0, rows=self.numRows, vgap=0)
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(
            self,
            id=wxID_FLEXGRIDGROWABLESDLG,
            name="FlexGridGrowablesDlg",
            parent=prnt,
            pos=wx.Point(139, 88),
        ...
        self.button2 = wx.Button(
            ...
            name="button2",
            parent=self,
            pos=wx.Point(332, 209),
            size=wx.Size(75, 23),
            style=0,
        )

        self.gridWin = wx.Window(
            id=wxID_FLEXGRIDGROWABLESDLGGRIDWIN,
            name="gridWin",
            parent=self,
            pos=wx.Point(32, 32),
        ...
        self.button3 = wx.Button(
            id=wxID_FLEXGRIDGROWABLESDLGBUTTON3,
            label=_("Editor"),
            name="button3",
            parent=self,
            pos=wx.Point(142, 209),
            size=wx.Size(75, 23),
            style=0,
        )
    ...
    def OnFlexgridgrowablesdlgSize(self, event):
        if self.rows and self.cols:
            ...
            self.gridWin.SetSize(
                tlPos.x,
                tlPos.y + tlSize.height,
