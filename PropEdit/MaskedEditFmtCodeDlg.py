...
formatCodes = [
    ...
    (
        "-",
        _(
            "Prepend and reserve leading space for sign to mask and allow signed values "
            "(negative #s shown in red by default)"
        ),
    ),
...
[
    wxID_MASKEDEDITFORMATCODESDLG,
    wxID_MASKEDEDITFORMATCODESDLGBTNCANCEL,
...
class MaskedEditFormatCodesDlg(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(
            self,
            id=wxID_MASKEDEDITFORMATCODESDLG,
            name="MaskedEditFormatCodesDlg",
            parent=prnt,
            pos=wx.Point(433, 218),
            size=wx.Size(436, 399),
        ...
        self.clbFormatCodes = wx.CheckListBox(
            choices=[],
            id=wxID_MASKEDEDITFORMATCODESDLGCLBFORMATCODES,
            name="clbFormatCodes",
            parent=self,
            pos=wx.Point(8, 33),
            size=wx.Size(413, 258),
            style=wx.LB_HSCROLL | wx.LB_SINGLE,
        )
        self.clbFormatCodes.SetConstraints(LayoutAnchors(self.clbFormatCodes, True, True, True, True))
        self.clbFormatCodes.Bind(
            wx.EVT_CHECKLISTBOX, self.OnClbformatcodesChecklistbox, id=wxID_MASKEDEDITFORMATCODESDLGCLBFORMATCODES
        )

        self.tcFormatCodePropVal = wx.TextCtrl(
            id=wxID_MASKEDEDITFORMATCODESDLGTCFORMATCODEPROPVAL,
            name="tcFormatCodePropVal",
            parent=self,
            pos=wx.Point(8, 299),
            size=wx.Size(413, 25),
            style=0,
            value=self.formatCode,
        )
        self.tcFormatCodePropVal.SetConstraints(LayoutAnchors(self.tcFormatCodePropVal, True, False, True, True))

        self.btnOK = wx.Button(
            id=wx.ID_OK, label=_("OK"), name="btnOK", parent=self, pos=wx.Point(261, 340), size=wx.Size(75, 23), style=0
        )
        self.btnOK.SetConstraints(LayoutAnchors(self.btnOK, False, False, True, True))
        ...
        self.btnCancel = wx.Button(
            ...
            name="btnCancel",
            parent=self,
            pos=wx.Point(346, 340),
            size=wx.Size(75, 23),
            style=0,
        )
        self.btnCancel.SetConstraints(LayoutAnchors(self.btnCancel, False, False, True, True))

        self.staticText1 = wx.StaticText(
            id=wxID_MASKEDEDITFORMATCODESDLGSTATICTEXT1,
        ...
        self.staticText1.SetConstraints(LayoutAnchors(self.staticText1, True, True, True, False))
