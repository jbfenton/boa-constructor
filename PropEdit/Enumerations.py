...
fontWeightNames = {"wx.NORMAL": wx.FONTWEIGHT_NORMAL, "wx.LIGHT": wx.FONTWEIGHT_LIGHT, "wx.BOLD": wx.FONTWEIGHT_BOLD}

splitterWindowSplitMode = [1, 2]
splitterWindowSplitModeNames = {"wx.SPLIT_HORIZONTAL": 1, "wx.SPLIT_VERTICAL": 2}

constraintEdges = ["wx.Left", "wx.Right", "wx.Top", "wx.Bottom", "wx.Height", "wx.Width", "wx.CentreX", "wx.CentreY"]
...
formatStyle = ["wx.LIST_FORMAT_LEFT", "wx.LIST_FORMAT_RIGHT", "wx.LIST_FORMAT_CENTRE", "wx.LIST_FORMAT_CENTER"]

sashLayoutOrientation = [wx.adv.LAYOUT_HORIZONTAL, wx.adv.LAYOUT_VERTICAL]
sashLayoutOrientationNames = {
    "wx.adv.LAYOUT_HORIZONTAL": wx.adv.LAYOUT_HORIZONTAL,
...
sashLayoutAlignmentNames = {
    "wx.adv.LAYOUT_NONE": wx.adv.LAYOUT_NONE,
