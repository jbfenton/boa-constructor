...
[
    wxID_KEYDEFSDIALOG,
    wxID_KEYDEFSDIALOGALTFLAGCHB,
    wxID_KEYDEFSDIALOGCANCELBTN,
    wxID_KEYDEFSDIALOGCTRLFLAGCHB,
    wxID_KEYDEFSDIALOGKEYCODECBB,
    wxID_KEYDEFSDIALOGOKBTN,
    wxID_KEYDEFSDIALOGSHIFTFLAGCHB,
    wxID_KEYDEFSDIALOGSHORTCUTTC,
    wxID_KEYDEFSDIALOGSTATICBOX1,
    wxID_KEYDEFSDIALOGSTATICTEXT1,
...
class KeyDefsDialog(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(
            self,
            id=wxID_KEYDEFSDIALOG,
            name="KeyDefsDialog",
            parent=prnt,
            pos=wx.Point(430, 271),
            size=wx.Size(298, 184),
        ...
        self.staticBox1 = wx.StaticBox(
            id=wxID_KEYDEFSDIALOGSTATICBOX1,
            label="Flags",
            name="staticBox1",
            parent=self,
            pos=wx.Point(8, 8),
        ...
        self.ctrlFlagChb.Bind(wx.EVT_CHECKBOX, self.OnUpdateShortcut, id=wxID_KEYDEFSDIALOGCTRLFLAGCHB)

        self.altFlagChb = wx.CheckBox(
        ...
        self.altFlagChb.Bind(wx.EVT_CHECKBOX, self.OnUpdateShortcut, id=wxID_KEYDEFSDIALOGALTFLAGCHB)

        self.shiftFlagChb = wx.CheckBox(
            id=wxID_KEYDEFSDIALOGSHIFTFLAGCHB,
            label="wx.ACCEL_SHIFT",
            name="shiftFlagChb",
            parent=self,
            pos=wx.Point(16, 72),
            size=wx.Size(120, 19),
        ...
        self.shiftFlagChb.Bind(wx.EVT_CHECKBOX, self.OnUpdateShortcut, id=wxID_KEYDEFSDIALOGSHIFTFLAGCHB)

        self.keyCodeCbb = wx.ComboBox(
            choices=self.preDefKeys,
        ...
        self.keyCodeCbb.Bind(wx.EVT_COMBOBOX, self.OnUpdateShortcutKeyCodeCbb, id=wxID_KEYDEFSDIALOGKEYCODECBB)
        self.keyCodeCbb.Bind(wx.EVT_TEXT, self.OnUpdateShortcutKeyCodeCbb, id=wxID_KEYDEFSDIALOGKEYCODECBB)

        self.staticText1 = wx.StaticText(
            id=wxID_KEYDEFSDIALOGSTATICTEXT1,
            label=_("Key code:"),
            name="staticText1",
            parent=self,
            pos=wx.Point(152, 16),
        ...
        self.staticText2 = wx.StaticText(
            id=wxID_KEYDEFSDIALOGSTATICTEXT2,
            label=_("Shortcut text:"),
            name="staticText2",
            parent=self,
            pos=wx.Point(152, 64),
            size=wx.Size(120, 13),
        ...
        self.shortcutTc = wx.TextCtrl(
            id=wxID_KEYDEFSDIALOGSHORTCUTTC,
            name="shortcutTc",
            parent=self,
            pos=wx.Point(152, 80),
            size=wx.Size(124, 21),
        ...
        self.okBtn = wx.Button(
            ...
            name="okBtn",
            parent=self,
            pos=wx.Point(120, 120),
            size=wx.Size(75, 23),
            style=0,
        )
        self.okBtn.Bind(wx.EVT_BUTTON, self.OnOkbtnButton, id=wxID_KEYDEFSDIALOGOKBTN)
        ...
        self.cancelBtn = wx.Button(
            ...
            name="cancelBtn",
            parent=self,
            pos=wx.Point(200, 120),
            size=wx.Size(75, 23),
            style=0,
        )
        self.cancelBtn.Bind(wx.EVT_BUTTON, self.OnCancelbtnButton, id=wxID_KEYDEFSDIALOGCANCELBTN)
    ...
    def __init__(self, parent, entryName, accelEntry):
        ...
        self.SetAcceleratorTable(wx.AcceleratorTable([Utils.setupCloseWindowOnEscape(self)]))

        self.flagCtrls = (
            (self.ctrlFlagChb, wx.ACCEL_CTRL),
        ...
        if keyCode not in list(specialKeys.keys()) + otherKeys1 + otherKeys2:
            if len(keyCode) != 1 or keyCode not in string.ascII_letters + string.digits:
                raise InvalidValueError(
                    _(
                        "Key code must either be a single character (letter or digit) or an identifier selected "
                        "from the combobox"
                    )
                )
...
flagValNames = {
    wx.ACCEL_CTRL: ("wx.ACCEL_CTRL", "Ctrl"),
