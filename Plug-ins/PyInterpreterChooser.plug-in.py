...
[
    wxID_PYINTERPRETERCHOOSERDLG,
    wxID_PYINTERPRETERCHOOSERDLGBTNCANCEL,
...
class PyInterpreterChooserDlg(wx.Dialog):
    def _init_coll_browserSizer_Items(self, parent):
        ...
        parent.Add(self.lcInstallations, 1, border=10, flag=wx.GROW | wx.ALL)
        parent.Add(self.gdcInstallPath, 1, border=10, flag=wx.GROW | wx.ALL)

    def _init_coll_buttonsSizer_Items(self, parent):
        # generated method, don't edit

        parent.Add(self.btnOK, 0, border=10, flag=wx.ALL)
        parent.Add(self.btnCancel, 0, border=10, flag=wx.ALL)

    def _init_coll_mainSizer_Items(self, parent):
        # generated method, don't edit

        parent.Add(self.staticText1, 0, border=10, flag=wx.EXPAND | wx.ALL)
        parent.Add(self.browserSizer, 1, border=0, flag=wx.GROW)
        parent.Add(self.staticText2, 0, border=10, flag=wx.EXPAND | wx.ALL)
        parent.Add(self.txtPyIntpPath, 0, border=10, flag=wx.GROW | wx.ALL)
        parent.Add(self.buttonsSizer, 0, border=0, flag=wx.ALIGN_RIGHT | wx.ALL)

    def _init_coll_lcInstallations_Columns(self, parent):
        # generated method, don't edit

        parent.InsertColumn(col=0, format=wx.LIST_FORMAT_LEFT, heading=_("Version"), width=60)
        parent.InsertColumn(col=1, format=wx.LIST_FORMAT_LEFT, heading=_("Install Path"), width=170)
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(
            self,
            id=wxID_PYINTERPRETERCHOOSERDLG,
            name="PyInterpreterChooserDlg",
            parent=prnt,
            pos=wx.Point(548, 354),
            size=wx.Size(532, 358),
        ...
        self.staticText1 = wx.StaticText(
            id=wxID_PYINTERPRETERCHOOSERDLGSTATICTEXT1,
        ...
        self.gdcInstallPath = wx.GenericDirCtrl(
            defaultFilter=0,
            dir=".",
        ...
        self.lcInstallations = wx.ListView(
            winid=wxID_PYINTERPRETERCHOOSERDLGLCINSTALLATIONS,
            name="lcInstallations",
            parent=self,
            pos=wx.Point(10, 52),
            size=wx.Size(242, 146),
        ...
        self.staticText2 = wx.StaticText(
            id=wxID_PYINTERPRETERCHOOSERDLGSTATICTEXT2,
        ...
        self.txtPyIntpPath = wx.TextCtrl(
            id=wxID_PYINTERPRETERCHOOSERDLGTXTPYINTPPATH,
            name="txtPyIntpPath",
            parent=self,
            pos=wx.Point(10, 257),
            size=wx.Size(504, 21),
            style=0,
            value=self.pythonInterpreterPath,
        )
    ...
    def __init__(self, parent, currentPyIntpPath=""):
        ...
        self.gdcInstallPath.GetChildren()[0].Bind(wx.EVT_LEFT_DCLICK, self.OnGdcinstallpathLeftDclick)
    ...
    def getInstallations(self):
        ...
        for version in versions:
            try:
                reg = winreg.OpenKey(winreg.HKEY_CURRENT_USER, "%s\\%s" % (PyCoreRegPath, version))
            except EnvironmentError:
                continue
            try:
                pyIntpPath = os.path.join(winreg.QueryValue(reg, "InstallPath"), "Python.exe")
            except WindowsError:
                continue
        ...
        if pyIntpPath != Preferences.pythonInterpreterPath:
            ...
            for ver, path in dlg.installedPaths:
                ...
                for path in Preferences.picExtraPaths:
                    ...
                    Plugins.updateRcFile(
                        "prefs_plug-ins_rc.py", "picExtraPaths", repr(Preferences.picExtraPaths + [pyIntpPath])
                    )
    finally:
        dlg.Destroy()
...
Plugins.registerPreference(
    "PyInterpreterChooser", "picExtraPaths", "[]", ["Additional locations to choose the Python Interpreter Path from."]
)
Plugins.registerTool(_("Python interpreter chooser"), openPyInterpChooser, "Images/PyInterpreterChooser.png")
