...
Plugins.registerComponents(
    "User",
    (wx.lib.bcrtl.user.ExampleST.ExampleStaticText, "ExampleStaticText", ExampleSTDTC),
    (wx.lib.bcrtl.user.StaticTextCtrl.StaticTextCtrl, "StaticTextCtrl", StaticTextCtrlDTC),
)
