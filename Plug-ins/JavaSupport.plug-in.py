...
Plugins.registerPreference("JavaSupport", "jsJavaCompilerPath", "''", ["Path to the compiler"], "type: filepath")
...
class JavaStyledTextCtrlMix(StyledTextCtrls.LanguageSTCMix):
    def __init__(self, wId):
        StyledTextCtrls.LanguageSTCMix.__init__(self, wId, (0, Preferences.STCLineNumMarginWidth), "java", java_cfgfile)
        self.setStyles()
...
class JavaSourceView(SourceViews.EditorStyledTextCtrl, JavaStyledTextCtrlMix):
    ...
    def __init__(self, parent, model):
        SourceViews.EditorStyledTextCtrl.__init__(self, parent, wxID_JAVASOURCEVIEW, model, (), -1)
...
javaStyleEditorConfig = (
    ...
    "'mono': 'Courier New', 'ln-size': 8, 'helv': 'Lucida Console'}\n"
    "common.defs.gtk={'mono': 'Courier', 'helv': 'Helvetica', 'other': "
    "'new century schoolbook', 'size': 9, 'ln-size': 6, "
    "'backcol': '#FFFFFF'}\n"
    ...
    "keywords=abstract double int strictfp boolean else interface super "
    "break extends long switch byte final native synchronized case finally "
    "new this catch float package throw har for private throws class goto "
    "protected transient const if public try continue implements return "
    "void default import short volatile do instanceof static while True "
    "False null\n"
    "lexer=wx.stc.STC_LEX_CPP\n"
    "styleidnames={wx.stc.STC_C_DEFAULT: 'Default', "
    ...
    "wx.stc.STC_C_CHARACTER: 'Character',"
    "wx.stc.STC_C_UUID: 'UUID',"
    "wx.stc.STC_C_PREPROCESSOR: 'Preprocessor',"
    "wx.stc.STC_C_OPERATOR: 'Operator', "
    "wx.stc.STC_C_IDENTIFIER: 'Identifier', "
    "wx.stc.STC_C_STRINGEOL: 'EOL unclosed string', "
    "wx.stc.STC_C_VERBATIM: 'Verbatim'}\n"
)
