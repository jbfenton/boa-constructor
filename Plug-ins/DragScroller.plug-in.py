...
Plugins.registerComponent(
    "Library", wx.lib.dragscroller.DragScroller, "wx.lib.dragscroller.DragScroller", DragScrollerDTC
)

Preferences.IS.registerImage("Images/Palette/wx.lib.dragscroller.DragScroller.png", getDragScrollerData())
