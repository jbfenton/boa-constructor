...
class FlatNotebookDTC(BookCtrlDTC):
    ...
    def designTimeControl(self, position, size, args=None):
        ...
        ctrl.Bind(wx.lib.flatnotebook.EVT_FLATNOTEBOOK_PAGE_CHANGED, self.OnPageChanged, id=ctrl.GetId())
...
Plugins.registerComponent(
    "Library", wx.lib.flatnotebook.FlatNotebook, "wx.lib.flatnotebook.FlatNotebook", FlatNotebookDTC
)
