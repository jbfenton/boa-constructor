...
Plugins.registerPreference("PascalSupport", "psPascalCompilerPath", "''", ["Path to the compiler"], "type: filepath")
...
class PascalStyledTextCtrlMix(StyledTextCtrls.LanguageSTCMix):
    def __init__(self, wId):
        StyledTextCtrls.LanguageSTCMix.__init__(
            self, wId, (0, Preferences.STCLineNumMarginWidth), "pascal", pascal_cfgfile
        )
        self.setStyles()
...
pascalStyleEditorConfig = (
    ...
    "'new century schoolbook', 'size': 9, 'lnsize': 6, "
    "'backcol': '#FFFFFF'}\n"
