...
[
    wxID_REGEXEDITORFRM,
    wxID_REGEXEDITORFRMCLBFLAGS,
    wxID_REGEXEDITORFRMLCGROUPS,
    wxID_REGEXEDITORFRMPANEL,
    wxID_REGEXEDITORFRMRBACTION,
    wxID_REGEXEDITORFRMSTATICTEXT1,
    wxID_REGEXEDITORFRMSTATICTEXT2,
    wxID_REGEXEDITORFRMSTATICTEXT3,
    wxID_REGEXEDITORFRMSTATICTEXT4,
    wxID_REGEXEDITORFRMSTATICTEXT5,
    wxID_REGEXEDITORFRMSTATUSBAR,
    wxID_REGEXEDITORFRMTXTMATCH,
    wxID_REGEXEDITORFRMTXTREGEX,
...
class RegexEditorFrm(wx.Frame, Utils.FrameRestorerMixin):
    def _init_coll_lcGroups_Columns(self, parent):
        ...
        parent.InsertColumn(col=0, format=wx.LIST_FORMAT_LEFT, heading="#", width=35)
        parent.InsertColumn(col=1, format=wx.LIST_FORMAT_LEFT, heading="Name", width=75)
        parent.InsertColumn(col=2, format=wx.LIST_FORMAT_LEFT, heading="Value", width=117)
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(
            self,
            id=wxID_REGEXEDITORFRM,
            name="RegexEditorFrm",
            parent=prnt,
            pos=wx.Point(562, 278),
            size=wx.Size(503, 509),
            style=wx.DEFAULT_FRAME_STYLE,
            title=_("Regex Editor"),
        )
        self.SetClientSize(wx.Size(495, 482))

        self.panel = wx.Panel(
            id=wxID_REGEXEDITORFRMPANEL,
            name="panel",
            parent=self,
            pos=wx.Point(0, 0),
            size=wx.Size(495, 462),
            style=wx.TAB_TRAVERSAL,
        )
        self.panel.SetAutoLayout(True)

        self.staticText1 = wx.StaticText(
            id=wxID_REGEXEDITORFRMSTATICTEXT1,
        ...
        self.txtRegex = wx.TextCtrl(
            id=wxID_REGEXEDITORFRMTXTREGEX,
            name="txtRegex",
            parent=self.panel,
            pos=wx.Point(8, 32),
            size=wx.Size(352, 120),
            style=wx.TE_MULTILINE,
            value="",
        )
        self.txtRegex.SetConstraints(LayoutAnchors(self.txtRegex, True, True, True, False))
        self.txtRegex.Bind(wx.EVT_TEXT, self.OnUpdate, id=wxID_REGEXEDITORFRMTXTREGEX)

        self.staticText2 = wx.StaticText(
            id=wxID_REGEXEDITORFRMSTATICTEXT2,
            label=_("String"),
            name="staticText2",
            parent=self.panel,
            pos=wx.Point(8, 160),
        ...
        self.txtString = wx.TextCtrl(
            id=wxID_REGEXEDITORFRMTXTSTRING,
            name="txtString",
            parent=self.panel,
            pos=wx.Point(8, 184),
            size=wx.Size(351, 112),
            style=wx.TE_MULTILINE,
            value="",
        )
        self.txtString.SetConstraints(LayoutAnchors(self.txtString, True, True, True, False))
        self.txtString.Bind(wx.EVT_TEXT, self.OnUpdate, id=wxID_REGEXEDITORFRMTXTSTRING)

        self.staticText3 = wx.StaticText(
            id=wxID_REGEXEDITORFRMSTATICTEXT3,
            label=_("Match"),
            name="staticText3",
            parent=self.panel,
            pos=wx.Point(8, 304),
        ...
        self.clbFlags = wx.CheckListBox(
            choices=["IGNORECASE", "LOCALE", "MULTILINE", "DOTALL", "UNICODE", "VERBOSE"],
            id=wxID_REGEXEDITORFRMCLBFLAGS,
            name="clbFlags",
            parent=self.panel,
            pos=wx.Point(375, 32),
            size=wx.Size(112, 120),
            style=0,
        )
        self.clbFlags.SetConstraints(LayoutAnchors(self.clbFlags, False, True, True, False))
        self.clbFlags.Bind(wx.EVT_CHECKLISTBOX, self.OnUpdate, id=wxID_REGEXEDITORFRMCLBFLAGS)

        self.staticText4 = wx.StaticText(
            id=wxID_REGEXEDITORFRMSTATICTEXT4,
            label=_("Groups"),
            name="staticText4",
            parent=self.panel,
            pos=wx.Point(256, 304),
            size=wx.Size(64, 13),
            style=0,
        )

        self.rbAction = wx.RadioBox(
            choices=[_("Search"), _("Match")],
            id=wxID_REGEXEDITORFRMRBACTION,
            label=_("Action"),
            majorDimension=1,
            name="rbAction",
            parent=self.panel,
            pos=wx.Point(376, 176),
            size=wx.Size(112, 120),
            style=wx.RA_SPECIFY_COLS,
        )
        self.rbAction.SetConstraints(LayoutAnchors(self.rbAction, False, True, True, False))
        self.rbAction.Bind(wx.EVT_RADIOBOX, self.OnUpdate, id=wxID_REGEXEDITORFRMRBACTION)

        self.statusBar = wx.StatusBar(
            id=wxID_REGEXEDITORFRMSTATUSBAR, name="statusBar", parent=self, style=wx.STB_SIZEGRIP
        )
        ...
        self.staticText5 = wx.StaticText(
            id=wxID_REGEXEDITORFRMSTATICTEXT5,
            label=_("Flags"),
            name="staticText5",
            parent=self.panel,
            pos=wx.Point(378, 8),
        ...
        self.staticText5.SetConstraints(LayoutAnchors(self.staticText5, False, True, True, False))

        self.txtMatch = wx.TextCtrl(
            id=wxID_REGEXEDITORFRMTXTMATCH,
            name="txtMatch",
            parent=self.panel,
            pos=wx.Point(8, 328),
            size=wx.Size(232, 128),
            style=wx.TE_MULTILINE,
            value="",
        )
        self.txtMatch.SetConstraints(LayoutAnchors(self.txtMatch, True, True, False, True))

        self.lcGroups = wx.ListCtrl(
            id=wxID_REGEXEDITORFRMLCGROUPS,
            name="lcGroups",
            parent=self.panel,
            pos=wx.Point(256, 328),
            size=wx.Size(231, 128),
            style=wx.LC_REPORT,
        )
        self.lcGroups.SetConstraints(LayoutAnchors(self.lcGroups, True, True, True, True))
    ...
    def __init__(self, parent):
        ...
        self.statusImages = [
            wx.ArtProvider.GetBitmap(artId, wx.ART_TOOLBAR, (16, 16)) for artId in (wx.ART_ERROR, wx.ART_INFORMATION)
        ]

        rect = self.statusBar.GetFieldRect(0)
        self.sbImage = wx.StaticBitmap(self.statusBar, -1, self.statusImages[0], (rect.x + 1, rect.y + 1), (16, 16))
