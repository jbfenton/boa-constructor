...
[
    wxID_MODULEFINDERDLG,
    wxID_MODULEFINDERDLGCANCELBTN,
    wxID_MODULEFINDERDLGOKBTN,
    wxID_MODULEFINDERDLGSTATICTEXT1,
...
class ModuleFinderDlg(wx.Dialog):
    def _init_coll_mainSizer_Items(self, parent):
        ...
        parent.Add(self.staticText1, 0, border=10, flag=wx.ALL | wx.EXPAND)
        parent.Add(self.txtModuleName, 0, border=10, flag=wx.EXPAND | wx.RIGHT | wx.LEFT)
        parent.Add(self.buttonsSizer, 0, border=10, flag=wx.ALIGN_RIGHT | wx.ALL)
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(
            self,
            id=wxID_MODULEFINDERDLG,
            name="ModuleFinderDlg",
            parent=prnt,
            pos=wx.Point(858, 575),
        ...
        self.staticText1 = wx.StaticText(
            id=wxID_MODULEFINDERDLGSTATICTEXT1,
            label=_("Module name:"),
            name="staticText1",
            parent=self,
            pos=wx.Point(10, 10),
        ...
        self.txtModuleName = wx.TextCtrl(
            id=wxID_MODULEFINDERDLGTXTMODULENAME,
            name="txtModuleName",
            parent=self,
            pos=wx.Point(10, 36),
            size=wx.Size(289, 21),
        ...
        self.okBtn = wx.Button(
            id=wx.ID_OK, label=_("OK"), name="okBtn", parent=self, pos=wx.Point(139, 67), size=wx.Size(75, 23), style=0
        )
...
def openModuleFinder(editor):
    ...
    try:
        while dlg.ShowModal() == wx.ID_OK:
            ...
            try:
                f, filename, (ext, mode, type) = Utils.find_dotted_module(modName)  # , sys.path)
...
Plugins.registerTool(_("Module finder"), openModuleFinder, "Images/ModuleFinder.png", keyIdent)
