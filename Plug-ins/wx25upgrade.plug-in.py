...
import Utils
from ExternalLib import reindent, wx25upgrade

[
    wxID_WX25CODEUPGRADEDLG,
    wxID_WX25CODEUPGRADEDLGSETFILE,
    wxID_WX25CODEUPGRADEDLGSETSOURCE,
    wxID_WX25CODEUPGRADEDLGSETTARGET,
    wxID_WX25CODEUPGRADEDLGSOURCEFILE,
    wxID_WX25CODEUPGRADEDLGSOURCEFOLDER,
    wxID_WX25CODEUPGRADEDLGSTARTFILE,
    wxID_WX25CODEUPGRADEDLGSTARTFOLDER,
    wxID_WX25CODEUPGRADEDLGSTATICTEXT1,
    wxID_WX25CODEUPGRADEDLGSTATICTEXT2,
    wxID_WX25CODEUPGRADEDLGSTFILE,
    wxID_WX25CODEUPGRADEDLGSTSOURCEFOLDER,
    wxID_WX25CODEUPGRADEDLGSTTARGETFOLDER,
    wxID_WX25CODEUPGRADEDLGTARGETFOLDER,
...
class Wx25CodeUpgradeDlg(wx.Dialog):
    def _init_coll_flexGridSizer1_Items(self, parent):
        ...
        parent.AddWindow(self.stSourceFolder, 1, border=2, flag=wx.ALIGN_CENTER_VERTICAL | wx.ALL)
        parent.AddWindow(self.sourceFolder, 1, border=2, flag=wx.ALL)
        parent.AddWindow(self.stTargetFolder, 1, border=2, flag=wx.ALIGN_CENTER_VERTICAL | wx.ALL)
        parent.AddWindow(self.targetFolder, 1, border=2, flag=wx.ALL)
        parent.AddWindow(self.stFile, 1, border=2, flag=wx.ALIGN_CENTER_VERTICAL | wx.ALL)
    ...
    def _init_coll_bsDialog_Items(self, parent):
        ...
        parent.AddWindow(self.staticText1, 0, border=10, flag=wx.ALIGN_LEFT | wx.ALL)
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(
            self,
            id=wxID_WX25CODEUPGRADEDLG,
            name="Wx25CodeUpgradeDlg",
            parent=prnt,
            pos=wx.Point(527, 423),
            size=wx.Size(573, 220),
        ...
        self.stSourceFolder = wx.StaticText(
            id=wxID_WX25CODEUPGRADEDLGSTSOURCEFOLDER,
            label="Source Folder:",
            name="stSourceFolder",
            parent=self,
            pos=wx.Point(4, 8),
        ...
        self.sourceFolder = wx.TextCtrl(
            id=wxID_WX25CODEUPGRADEDLGSOURCEFOLDER,
            name="sourceFolder",
            parent=self,
            pos=wx.Point(108, 4),
            size=wx.Size(435, 21),
        ...
        self.targetFolder = wx.TextCtrl(
            id=wxID_WX25CODEUPGRADEDLGTARGETFOLDER,
            name="targetFolder",
            parent=self,
            pos=wx.Point(108, 29),
            size=wx.Size(435, 21),
        ...
        self.stTargetFolder = wx.StaticText(
            id=wxID_WX25CODEUPGRADEDLGSTTARGETFOLDER,
            label="Target Folder",
            name="stTargetFolder",
            parent=self,
            pos=wx.Point(4, 33),
        ...
        self.stFile = wx.StaticText(
            id=wxID_WX25CODEUPGRADEDLGSTFILE,
            label="File (individual):",
            name="stFile",
            parent=self,
            pos=wx.Point(4, 57),
            size=wx.Size(100, 13),
        ...
        self.sourceFile = wx.TextCtrl(
            id=wxID_WX25CODEUPGRADEDLGSOURCEFILE,
            name="sourceFile",
            parent=self,
            pos=wx.Point(108, 54),
            size=wx.Size(435, 21),
        ...
        self.staticText1 = wx.StaticText(
            id=wxID_WX25CODEUPGRADEDLGSTATICTEXT1,
        ...
        self.setSource = wx.Button(
            id=wxID_WX25CODEUPGRADEDLGSETSOURCE,
            label="Set Source Folder",
            name="setSource",
            parent=self,
            pos=wx.Point(4, 114),
            size=wx.Size(100, 23),
        ...
        self.setSource.Bind(wx.EVT_BUTTON, self.OnSetSourceButton, id=wxID_WX25CODEUPGRADEDLGSETSOURCE)

        self.setTarget = wx.Button(
            id=wxID_WX25CODEUPGRADEDLGSETTARGET,
            label="Set Target Folder",
            name="setTarget",
            parent=self,
            pos=wx.Point(108, 114),
            size=wx.Size(97, 23),
            style=0,
        )
        self.setTarget.Bind(wx.EVT_BUTTON, self.OnSetTargetButton, id=wxID_WX25CODEUPGRADEDLGSETTARGET)

        self.startFolder = wx.Button(
            id=wxID_WX25CODEUPGRADEDLGSTARTFOLDER,
            label="Convert Folder",
            name="start",
            parent=self,
            pos=wx.Point(209, 114),
            size=wx.Size(92, 23),
            style=0,
        )
        self.startFolder.Bind(wx.EVT_BUTTON, self.OnStartFolderButton, id=wxID_WX25CODEUPGRADEDLGSTARTFOLDER)

        self.setFile = wx.Button(
        ...
        self.setFile.Bind(wx.EVT_BUTTON, self.OnSetFileButton, id=wxID_WX25CODEUPGRADEDLGSETFILE)

        self.startFile = wx.Button(
            id=wxID_WX25CODEUPGRADEDLGSTARTFILE,
            label="Convert File",
            name="startFile",
            parent=self,
            pos=wx.Point(108, 141),
            size=wx.Size(92, 23),
            style=0,
        )
        self.startFile.Bind(wx.EVT_BUTTON, self.OnStartFileButton, id=wxID_WX25CODEUPGRADEDLGSTARTFILE)

        self.upgradeGuide = wx.Button(
            id=wxID_WX25CODEUPGRADEDLGUPGRADEGUIDE,
            label="Upgrade Guide",
            name="upgradeGuide",
            parent=self,
            pos=wx.Point(305, 141),
            size=wx.Size(103, 23),
            style=0,
        )
        self.upgradeGuide.Bind(wx.EVT_BUTTON, self.OnUpgradeGuideButton, id=wxID_WX25CODEUPGRADEDLGUPGRADEGUIDE)

        self.StaticText2 = wx.StaticText(
            id=wxID_WX25CODEUPGRADEDLGSTATICTEXT2,
    ...
    def OnSetSourceButton(self, event):
        dlg = wx.DirDialog(self, defaultPath=self.sourceFolderName, style=wx.DD_DEFAULT_STYLE | wx.DD_NEW_DIR_BUTTON)
        try:
    ...
    def OnSetTargetButton(self, event):
        dlg = wx.DirDialog(self, defaultPath=self.targetFolderName, style=wx.DD_DEFAULT_STYLE | wx.DD_NEW_DIR_BUTTON)
        try:
            if dlg.ShowModal() == wx.ID_OK:
                dir = dlg.GetPath()
    ...
    def OnStartFolderButton(self, event):
        ...
        if not os.path.isdir(targetFolder):
            if (
                wx.MessageBox("Target folder does not exist, create it?", "Create folder", wx.YES_NO | wx.ICON_QUESTION)
                == wx.NO
            ):
                return
        ...
        try:
            ...
            dlg = wx.ProgressDialog(
                "Converting source files", "Starting conversion of source files", maximum=max, parent=self
            )
            ...
            for name in files:
                ...
                if ext == ".py":
                    ...
                    dlg.Update(count, temp)

                    fInputName = os.path.join(self.sourceFolder.GetValue(), name)
                    fInputLines = open(fInputName, "r").readlines()
                    fInputData = self.reindentSource(fInputLines, fInputName)
                    fOutput = open(os.path.join(self.targetFolder.GetValue(), name), "w")
                    try:
            ...
            dlg.Update(count, "We are all done")
        finally:
            dlg.Destroy()
    ...
    def OnStartFileButton(self, event):
        max = 2
        dlg = wx.ProgressDialog(
            "Converting source file", "Starting conversion of source file\n\n", maximum=max, parent=self
        )
        count = 0
