...
[
    wxEVT_CWB_BEFORENAVIGATE,
    wxEVT_CWB_TITLECHANGE,
    wxEVT_CWB_DOWNLOADBEGIN,
    wxEVT_CWB_PROPERTYCHANGE,
    wxEVT_CWB_COMMANDSTATECHANGE,
    wxEVT_CWB_FRAMEBEFORENAVIGATE,
    wxEVT_CWB_WINDOWACTIVATE,
    wxEVT_CWB_NEWWINDOW,
    wxEVT_CWB_DOWNLOADCOMPLETE,
    wxEVT_CWB_WINDOWRESIZE,
    wxEVT_CWB_WINDOWMOVE,
    wxEVT_CWB_PROGRESSCHANGE,
    wxEVT_CWB_FRAMENEWWINDOW,
    wxEVT_CWB_STATUSTEXTCHANGE,
    wxEVT_CWB_FRAMENAVIGATECOMPLETE,
    wxEVT_CWB_QUIT,
    wxEVT_CWB_NAVIGATECOMPLETE,
] = [wx.NewIdRef(count=1) for _init_events in range(17)]
...
class wxComWebBrowserEvents:
    ...
    def OnBeforeNavigate(
        ...
        wx.PostEvent(
            self.eventhandler,
            wxComWebBrowserEvent(
                wxEVT_CWB_BEFORENAVIGATE,
                varnames2dict(self.OnBeforeNavigate.__func__.__code__.co_varnames[1:], locals()),
            ),
        )
    ...
    def OnTitleChange(self, Text=defaultNamedNotOptArg):
        ...
        wx.PostEvent(
            self.eventhandler,
            wxComWebBrowserEvent(
                wxEVT_CWB_TITLECHANGE, varnames2dict(self.OnTitleChange.__func__.__code__.co_varnames[1:], locals())
            ),
        )
    ...
    def OnDownloadBegin(self):
        ...
        wx.PostEvent(
            self.eventhandler,
            wxComWebBrowserEvent(
                wxEVT_CWB_DOWNLOADBEGIN, varnames2dict(self.OnDownloadBegin.__func__.__code__.co_varnames[1:], locals())
            ),
        )
    ...
    def OnPropertyChange(self, Property=defaultNamedNotOptArg):
        ...
        wx.PostEvent(
            ...
            wxComWebBrowserEvent(
                wxEVT_CWB_PROPERTYCHANGE,
                varnames2dict(self.OnPropertyChange.__func__.__code__.co_varnames[1:], locals()),
            ),
        )
    ...
    def OnCommandStateChange(self, Command=defaultNamedNotOptArg, Enable=defaultNamedNotOptArg):
        ...
        wx.PostEvent(
            ...
            wxComWebBrowserEvent(
                wxEVT_CWB_COMMANDSTATECHANGE,
                varnames2dict(self.OnCommandStateChange.__func__.__code__.co_varnames[1:], locals()),
            ),
        )

    def OnFrameBeforeNavigate(
        self,
        URL=defaultNamedNotOptArg,
        Flags=defaultNamedNotOptArg,
        TargetFrameName=defaultNamedNotOptArg,
        ...
        wx.PostEvent(
            ...
            wxComWebBrowserEvent(
                wxEVT_CWB_FRAMEBEFORENAVIGATE,
                varnames2dict(self.OnFrameBeforeNavigate.__func__.__code__.co_varnames[1:], locals()),
            ),
        )
    ...
    def OnWindowActivate(self):
        ...
        wx.PostEvent(
            ...
            wxComWebBrowserEvent(
                wxEVT_CWB_WINDOWACTIVATE,
                varnames2dict(self.OnWindowActivate.__func__.__code__.co_varnames[1:], locals()),
            ),
        )
    ...
    def OnNewWindow(
        ...
        PostData=defaultNamedNotOptArg,
        Headers=defaultNamedNotOptArg,
        Processed=defaultNamedNotOptArg,
    ):
        "Fired when a new window should be created."
        wx.PostEvent(
            self.eventhandler,
            wxComWebBrowserEvent(
                wxEVT_CWB_NEWWINDOW, varnames2dict(self.OnNewWindow.__func__.__code__.co_varnames[1:], locals())
            ),
        )
    ...
    def OnDownloadComplete(self):
        ...
        wx.PostEvent(
            ...
            wxComWebBrowserEvent(
                wxEVT_CWB_DOWNLOADCOMPLETE,
                varnames2dict(self.OnDownloadComplete.__func__.__code__.co_varnames[1:], locals()),
            ),
        )
    ...
    def OnWindowResize(self):
        ...
        wx.PostEvent(
            self.eventhandler,
            wxComWebBrowserEvent(
                wxEVT_CWB_WINDOWRESIZE, varnames2dict(self.OnWindowResize.__func__.__code__.co_varnames[1:], locals())
            ),
        )
    ...
    def OnWindowMove(self):
        ...
        wx.PostEvent(
            self.eventhandler,
            wxComWebBrowserEvent(
                wxEVT_CWB_WINDOWMOVE, varnames2dict(self.OnWindowMove.__func__.__code__.co_varnames[1:], locals())
            ),
        )
    ...
    def OnProgressChange(self, Progress=defaultNamedNotOptArg, ProgressMax=defaultNamedNotOptArg):
        ...
        wx.PostEvent(
            ...
            wxComWebBrowserEvent(
                wxEVT_CWB_PROGRESSCHANGE,
                varnames2dict(self.OnProgressChange.__func__.__code__.co_varnames[1:], locals()),
            ),
        )

    def OnFrameNewWindow(
        self,
        URL=defaultNamedNotOptArg,
        Flags=defaultNamedNotOptArg,
        TargetFrameName=defaultNamedNotOptArg,
        ...
        wx.PostEvent(
            ...
            wxComWebBrowserEvent(
                wxEVT_CWB_FRAMENEWWINDOW,
                varnames2dict(self.OnFrameNewWindow.__func__.__code__.co_varnames[1:], locals()),
            ),
        )
    ...
    def OnStatusTextChange(self, Text=defaultNamedNotOptArg):
        ...
        wx.PostEvent(
            ...
            wxComWebBrowserEvent(
                wxEVT_CWB_STATUSTEXTCHANGE,
                varnames2dict(self.OnStatusTextChange.__func__.__code__.co_varnames[1:], locals()),
            ),
        )
    ...
    def OnFrameNavigateComplete(self, URL=defaultNamedNotOptArg):
        ...
        wx.PostEvent(
            ...
            wxComWebBrowserEvent(
                wxEVT_CWB_FRAMENAVIGATECOMPLETE,
                varnames2dict(self.OnFrameNavigateComplete.__func__.__code__.co_varnames[1:], locals()),
            ),
        )
    ...
    def OnQuit(self, Cancel=defaultNamedNotOptArg):
        ...
        wx.PostEvent(
            self.eventhandler,
            wxComWebBrowserEvent(
                wxEVT_CWB_QUIT, varnames2dict(self.OnQuit.__func__.__code__.co_varnames[1:], locals())
            ),
        )
    ...
    def OnNavigateComplete(self, URL=defaultNamedNotOptArg):
        ...
        wx.PostEvent(
            ...
            wxComWebBrowserEvent(
                wxEVT_CWB_NAVIGATECOMPLETE,
                varnames2dict(self.OnNavigateComplete.__func__.__code__.co_varnames[1:], locals()),
            ),
        )
