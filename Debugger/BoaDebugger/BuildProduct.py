...
boaSrcModules = ["__init__", "IsolatedDebugger", "RemoteServer", "Tasks", "ZopeScriptDebugServer"]
...
def main():
    ...
    zipped.write("../../ExternalLib/xmlrpcserver.py", "BoaDebugger/Boa/ExternalLib/xmlrpcserver.py")
