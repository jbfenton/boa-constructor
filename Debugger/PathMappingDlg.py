...
[
    wxID_PATHSMAPPINGDLG,
    wxID_PATHSMAPPINGDLGCANCELBTN,
    wxID_PATHSMAPPINGDLGOKBTN,
    wxID_PATHSMAPPINGDLGPATHSPANEL,
...
class PathsMappingDlg(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.pathsPanel = PathsPanel(
            id=wxID_PATHSMAPPINGDLGPATHSPANEL,
            name="pathsPanel",
            parent=self,
            pos=wx.Point(0, 0),
        ...
        self.okBtn = wx.Button(
            id=wx.ID_OK, label=_("OK"), name="okBtn", parent=self, pos=wx.Point(320, 232), size=wx.Size(75, 23), style=0
        )
        self.okBtn.Bind(wx.EVT_BUTTON, self.OnOkbtnButton, id=wxID_PATHSMAPPINGDLGOKBTN)
