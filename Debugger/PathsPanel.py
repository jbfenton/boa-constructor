...
[
    wxID_PATHSPANEL,
    wxID_PATHSPANELADD_BTN,
    wxID_PATHSPANELGRID,
    wxID_PATHSPANELREMOVE_BTN,
    wxID_PATHSPANELSTATICBOX1,
...
class PathsPanel(wx.Panel):
    ...
    def _init_coll_boxSizer1_Items(self, parent):
        ...
        parent.Add(self.add_btn, 0, border=8, flag=wx.ALL)
        parent.Add(self.remove_btn, 0, border=8, flag=wx.BOTTOM | wx.TOP | wx.RIGHT)
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Panel.__init__(
            ...
            name="PathsPanel",
            parent=prnt,
            pos=wx.Point(316, 277),
            size=wx.Size(523, 274),
            style=wx.TAB_TRAVERSAL,
        )
        self.SetClientSize(wx.Size(515, 247))

        self.staticBox1 = wx.StaticBox(
            id=wxID_PATHSPANELSTATICBOX1,
            label=_("Server to client filepath mappings"),
            name="staticBox1",
            parent=self,
            pos=wx.Point(0, 0),
            size=wx.Size(515, 247),
            style=0,
        )

        self.grid = wx.grid.Grid(
            id=wxID_PATHSPANELGRID,
            name="grid",
            parent=self,
            pos=wx.Point(13, 25),
            size=wx.Size(489, 169),
        ...
        self.add_btn = wx.Button(
            ...
            name="add_btn",
            parent=self,
            pos=wx.Point(344, 210),
            size=wx.Size(75, 24),
            style=0,
        )
        self.add_btn.Bind(wx.EVT_BUTTON, self.OnAdd_btnButton, id=wxID_PATHSPANELADD_BTN)
        ...
        self.remove_btn = wx.Button(
            ...
            name="remove_btn",
            parent=self,
            pos=wx.Point(427, 210),
            size=wx.Size(75, 24),
            style=0,
        )
        self.remove_btn.Bind(wx.EVT_BUTTON, self.OnRemove_btnButton, id=wxID_PATHSPANELREMOVE_BTN)
    ...
    def read_paths(self):
        ...
        return [
            (self.grid.GetCellValue(row, 0), self.grid.GetCellValue(row, 1)) for row in range(self.grid.GetNumberRows())
        ]
