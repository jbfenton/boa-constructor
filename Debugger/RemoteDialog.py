...
from Debugger.PathsPanel import PathsPanel
from Utils import _
...
class AttachDlg(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.username_ctrl = wx.TextCtrl(
            id=wxID_ATTACHDLGUSERNAME_CTRL,
            name="username_ctrl",
            parent=self,
            pos=wx.Point(80, 80),
            size=wx.Size(96, 24),
        ...
        self.password_ctrl = wx.TextCtrl(
            id=wxID_ATTACHDLGPASSWORD_CTRL,
            name="password_ctrl",
            parent=self,
            pos=wx.Point(80, 112),
            size=wx.Size(96, 24),
        ...
        self.ok_button.Bind(wx.EVT_BUTTON, self.OnOkButton, id=wxID_ATTACHDLGOK_BUTTON)
        ...
        self.help_button.Bind(wx.EVT_BUTTON, self.OnHelpButton, id=wxID_ATTACHDLGHELP_BUTTON)

        self.rem_pass_ctrl = wx.CheckBox(
            id=wxID_ATTACHDLGREM_PASS_CTRL,
            label=_("Remember"),
            name="rem_pass_ctrl",
            parent=self,
        ...
        self.pathsPanel = PathsPanel(
            id=wxID_ATTACHDLGPATHSPANEL,
            name="pathsPanel",
            parent=self,
            pos=wx.Point(8, 144),
    ...
    def __init__(self, editor):
        ...
        if conf and conf.has_section("debugger.remote"):
            ...
            host, port, user, pwd, paths = self.rem_host, self.rem_port, self.rem_user, self.rem_pass, self.rem_pths
        self.conf = conf
    ...
    def OnOkButton(self, event):
        ...
        from Debugger.Debugger import DebuggerFrame
