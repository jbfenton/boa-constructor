...
[
    wxID_FINDREPLACEDLG,
    wxID_FINDREPLACEDLGBTNBROWSE,
    wxID_FINDREPLACEDLGBTNBUILDINFIND,
    wxID_FINDREPLACEDLGBTNFINDINFILES,
    wxID_FINDREPLACEDLGCANCELBTN,
    wxID_FINDREPLACEDLGCASESENSITIVECB,
    wxID_FINDREPLACEDLGCHKRECURSIVESEARCH,
    wxID_FINDREPLACEDLGCLOSEONFOUNDCB,
    wxID_FINDREPLACEDLGCMBFILEFILTER,
    wxID_FINDREPLACEDLGCMBFOLDER,
    wxID_FINDREPLACEDLGDIRECTIONRB,
    wxID_FINDREPLACEDLGFINDALLBTN,
    wxID_FINDREPLACEDLGFINDBTN,
    wxID_FINDREPLACEDLGFINDTXT,
    wxID_FINDREPLACEDLGOPTIONSSB,
    wxID_FINDREPLACEDLGREGEXPRCB,
    wxID_FINDREPLACEDLGREPLACEALLBTN,
    wxID_FINDREPLACEDLGREPLACEBTN,
    wxID_FINDREPLACEDLGREPLACETXT,
    wxID_FINDREPLACEDLGSCOPERB,
    wxID_FINDREPLACEDLGSTATICTEXT1,
    wxID_FINDREPLACEDLGSTATICTEXT2,
    wxID_FINDREPLACEDLGSTATICTEXT3,
    wxID_FINDREPLACEDLGSTATICTEXT4,
    wxID_FINDREPLACEDLGWHOLEWORDSCB,
    wxID_FINDREPLACEDLGWILDCARDCB,
...
class FindReplaceDlg(wx.Dialog):
    ...
    def _init_coll_topSizer_Items(self, parent):
        ...
        parent.Add(self.staticText2, 0, border=0, flag=wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL)
        parent.Add(self.findTxtSizer, 1, border=0, flag=wx.EXPAND)
        parent.Add(self.staticText1, 0, border=0, flag=wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL)
        parent.Add(self.replaceTxt, 1, border=0, flag=wx.EXPAND)
        parent.Add(self.staticText3, 0, border=0, flag=wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL)
        parent.Add(self.findFileSizer, 1, border=0, flag=wx.EXPAND)
        parent.Add(self.staticText4, 0, border=0, flag=wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL)
    ...
    def _init_coll_findFileSizer_Items(self, parent):
        ...
        parent.Add(self.cmbFileFilter, 1, border=0, flag=wx.EXPAND)
        parent.Add(self.btnBrowse, 0, border=3, flag=wx.LEFT | wx.ALIGN_CENTER)
    ...
    def _init_coll_findTxtSizer_Items(self, parent):
        ...
        parent.Add(self.btnBuildInFind, 0, border=3, flag=wx.LEFT | wx.ALIGN_CENTER)
    ...
    def _init_coll_radioBtnSizer_Items(self, parent):
        ...
        parent.Add(self.scopeRB, 0, border=10, flag=wx.ALIGN_CENTER | wx.TOP)
    ...
    def _init_coll_buttonSizer_Items(self, parent):
        ...
        parent.Add(self.findAllBtn, 0, border=4, flag=wx.EXPAND | wx.BOTTOM)
        parent.Add(self.btnFindInFiles, 0, border=4, flag=wx.EXPAND | wx.BOTTOM)
        parent.Add(self.replaceBtn, 0, border=4, flag=wx.EXPAND | wx.BOTTOM)
        parent.Add(self.replaceAllBtn, 0, border=4, flag=wx.EXPAND | wx.BOTTOM)
        parent.Add(self.cancelBtn, 0, border=4, flag=wx.EXPAND | wx.BOTTOM)
    ...
    def _init_coll_bottomSizer_Items(self, parent):
        ...
        parent.Add(self.radioBtnSizer, 0, border=5, flag=wx.EXPAND | wx.RIGHT | wx.LEFT)
        parent.Add(self.chekboxSizer, 1, border=5, flag=wx.BOTTOM | wx.EXPAND | wx.RIGHT)
        parent.Add(self.buttonSizer, 0, border=5, flag=wx.EXPAND | wx.RIGHT)
    ...
    def _init_sizers(self):
        ...
        self.chekboxSizer = wx.StaticBoxSizer(box=self.optionsSB, orient=wx.VERTICAL)
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(
            self,
            id=wxID_FINDREPLACEDLG,
            name="FindReplaceDlg",
            parent=prnt,
            pos=wx.Point(460, 453),
            size=wx.Size(460, 353),
            style=wx.DEFAULT_DIALOG_STYLE | wx.RESIZE_BORDER,
            title=_("Find/Replace"),
        )
        self.SetClientSize(wx.Size(452, 324))

        self.findTxt = wx.ComboBox(
            choices=[],
            id=wxID_FINDREPLACEDLGFINDTXT,
            name="findTxt",
            parent=self,
            pos=wx.Point(93, 9),
            size=wx.Size(327, 21),
        ...
        self.staticText2 = wx.StaticText(
            id=wxID_FINDREPLACEDLGSTATICTEXT2,
            label=_("Text to find"),
            name="staticText2",
            parent=self,
            pos=wx.Point(5, 5),
            size=wx.Size(83, 29),
        ...
        self.replaceTxt = wx.ComboBox(
            choices=[],
            id=wxID_FINDREPLACEDLGREPLACETXT,
            name="replaceTxt",
            parent=self,
            pos=wx.Point(93, 39),
            size=wx.Size(354, 21),
        ...
        self.staticText1 = wx.StaticText(
            id=wxID_FINDREPLACEDLGSTATICTEXT1,
        ...
        self.cmbFolder = wx.ComboBox(
            choices=[],
            id=wxID_FINDREPLACEDLGCMBFOLDER,
            name="cmbFolder",
            parent=self,
            pos=wx.Point(93, 99),
            size=wx.Size(354, 21),
        ...
        self.staticText3 = wx.StaticText(
            id=wxID_FINDREPLACEDLGSTATICTEXT3,
            label=_("Files to find in"),
            name="staticText3",
            parent=self,
            pos=wx.Point(5, 71),
            size=wx.Size(83, 17),
        ...
        self.cmbFileFilter = wx.ComboBox(
            choices=[],
            id=wxID_FINDREPLACEDLGCMBFILEFILTER,
            name="cmbFileFilter",
            parent=self,
            pos=wx.Point(93, 65),
            size=wx.Size(327, 21),
        ...
        self.staticText4 = wx.StaticText(
            id=wxID_FINDREPLACEDLGSTATICTEXT4,
            label=_("File filter"),
            name="staticText4",
            parent=self,
            pos=wx.Point(5, 99),
        ...
        self.directionRB = wx.RadioBox(
            choices=[_("Forward"), _("Backward")],
        ...
        self.directionRB.Bind(wx.EVT_RADIOBOX, self.OnDirectionrbRadiobox, id=wxID_FINDREPLACEDLGDIRECTIONRB)

        self.scopeRB = wx.RadioBox(
            choices=[_("All"), _("Selected")],
        ...
        self.scopeRB.Bind(wx.EVT_RADIOBOX, self.OnScoperbRadiobox, id=wxID_FINDREPLACEDLGSCOPERB)

        self.optionsSB = wx.StaticBox(
            id=wxID_FINDREPLACEDLGOPTIONSSB,
            label=_("Options"),
            name="optionsSB",
            parent=self,
            pos=wx.Point(101, 127),
            size=wx.Size(233, 192),
            style=0,
        )

        self.caseSensitiveCB = wx.CheckBox(
            id=wxID_FINDREPLACEDLGCASESENSITIVECB,
            label=_("Case sensitive"),
            name="caseSensitiveCB",
            parent=self,
            pos=wx.Point(106, 144),
            size=wx.Size(116, 22),
            style=0,
        )
        self.caseSensitiveCB.Bind(
            wx.EVT_CHECKBOX, self.OnCasesensitivecbCheckbox, id=wxID_FINDREPLACEDLGCASESENSITIVECB
        )

        self.wholeWordsCB = wx.CheckBox(
            id=wxID_FINDREPLACEDLGWHOLEWORDSCB,
            label=_("Whole words"),
            name="wholeWordsCB",
            parent=self,
            pos=wx.Point(106, 169),
            size=wx.Size(103, 22),
            style=0,
        )
        self.wholeWordsCB.Bind(wx.EVT_CHECKBOX, self.OnWholewordscbCheckbox, id=wxID_FINDREPLACEDLGWHOLEWORDSCB)

        self.wildcardCB = wx.CheckBox(
            id=wxID_FINDREPLACEDLGWILDCARDCB,
            label=_("Wildcards"),
            name="wildcardCB",
            parent=self,
            pos=wx.Point(106, 194),
            size=wx.Size(84, 22),
            style=0,
        )
        self.wildcardCB.Bind(wx.EVT_CHECKBOX, self.OnWildcardcbCheckbox, id=wxID_FINDREPLACEDLGWILDCARDCB)

        self.regExprCB = wx.CheckBox(
            id=wxID_FINDREPLACEDLGREGEXPRCB,
            label=_("Regular expressions"),
            name="regExprCB",
            parent=self,
            pos=wx.Point(106, 219),
            size=wx.Size(151, 22),
            style=0,
        )
        self.regExprCB.Bind(wx.EVT_CHECKBOX, self.OnRegexprcbCheckbox, id=wxID_FINDREPLACEDLGREGEXPRCB)

        self.wrapCB = wx.CheckBox(
            id=wxID_FINDREPLACEDLGWRAPCB,
            label=_("Wrap search"),
            name="wrapCB",
            parent=self,
            pos=wx.Point(106, 244),
            size=wx.Size(102, 22),
            style=0,
        )
        self.wrapCB.Bind(wx.EVT_CHECKBOX, self.OnWrapcbCheckbox, id=wxID_FINDREPLACEDLGWRAPCB)

        self.closeOnFoundCB = wx.CheckBox(
            id=wxID_FINDREPLACEDLGCLOSEONFOUNDCB,
            label=_("Close on found"),
            name="closeOnFoundCB",
            parent=self,
            pos=wx.Point(106, 269),
            size=wx.Size(195, 22),
            style=0,
        )
        self.closeOnFoundCB.Bind(wx.EVT_CHECKBOX, self.OnCloseonfoundcbCheckbox, id=wxID_FINDREPLACEDLGCLOSEONFOUNDCB)

        self.chkRecursiveSearch = wx.CheckBox(
            id=wxID_FINDREPLACEDLGCHKRECURSIVESEARCH,
            label=_("Recursive search"),
            name="chkRecursiveSearch",
            parent=self,
            pos=wx.Point(106, 294),
            size=wx.Size(131, 22),
            style=0,
        )
        ...
        self.findBtn = wx.Button(
            ...
            name="findBtn",
            parent=self,
            pos=wx.Point(339, 127),
            size=wx.Size(108, 27),
            style=0,
        )
        self.findBtn.Bind(wx.EVT_BUTTON, self.OnFindbtnButton, id=wxID_FINDREPLACEDLGFINDBTN)
        self.findBtn.Bind(wx.EVT_KEY_UP, self.OnFindtxtChar)

        self.findAllBtn = wx.Button(
            id=wxID_FINDREPLACEDLGFINDALLBTN,
            label=_("Find all"),
            name="findAllBtn",
            parent=self,
            pos=wx.Point(339, 158),
            size=wx.Size(108, 28),
            style=0,
        )
        self.findAllBtn.Bind(wx.EVT_BUTTON, self.OnFindallbtnButton, id=wxID_FINDREPLACEDLGFINDALLBTN)

        self.btnFindInFiles = wx.Button(
            id=wxID_FINDREPLACEDLGBTNFINDINFILES,
            label=_("Find in files"),
            name="btnFindInFiles",
            parent=self,
            pos=wx.Point(339, 190),
            size=wx.Size(108, 28),
            style=0,
        )
        self.btnFindInFiles.Bind(wx.EVT_BUTTON, self.OnFindInFiles, id=wxID_FINDREPLACEDLGBTNFINDINFILES)

        self.replaceBtn = wx.Button(
            id=wxID_FINDREPLACEDLGREPLACEBTN,
            label=_("Replace"),
            name="replaceBtn",
            parent=self,
            pos=wx.Point(339, 222),
            size=wx.Size(108, 28),
            style=0,
        )
        self.replaceBtn.Bind(wx.EVT_BUTTON, self.OnReplacebtnButton, id=wxID_FINDREPLACEDLGREPLACEBTN)

        self.replaceAllBtn = wx.Button(
            id=wxID_FINDREPLACEDLGREPLACEALLBTN,
            label=_("Replace all"),
            name="replaceAllBtn",
            parent=self,
            pos=wx.Point(339, 254),
            size=wx.Size(108, 28),
            style=0,
        )
        self.replaceAllBtn.Bind(wx.EVT_BUTTON, self.OnReplaceallbtnButton, id=wxID_FINDREPLACEDLGREPLACEALLBTN)
        ...
        self.cancelBtn = wx.Button(
            ...
            name="cancelBtn",
            parent=self,
            pos=wx.Point(339, 286),
            size=wx.Size(108, 28),
            style=0,
        )

        self.btnBuildInFind = wx.Button(
        ...
        self.btnBuildInFind.Bind(wx.EVT_BUTTON, self.OnBuildInFind, id=wxID_FINDREPLACEDLGBTNBUILDINFIND)

        self.btnBrowse = wx.Button(
        ...
        self.btnBrowse.Bind(wx.EVT_BUTTON, self.OnBrowse, id=wxID_FINDREPLACEDLGBTNBROWSE)
    ...
    def __init__(self, parent, engine, view, bModeFindReplace=1):
        ...
        self.SetAcceleratorTable(
            wx.AcceleratorTable(
                [
                    Utils.setupCloseWindowOnEscape(self),
    ...
    def findInFiles(self):
        ...
        dlg = wx.ProgressDialog(
            _("Building file list from directory '%s'") % (folder[0]),
            _("Searching..."),
            100,
            self.view,
    ...
    def _checkSelectionDlgOverlap(self):
        if self.view.viewName not in ("Package", "Application"):
            ...
            if selStart != selEnd and selStartLnNo == self.view.LineFromPosition(selEnd):
                ...
                selSize = wx.Size(self.view.ClientToScreen(self.view.PointFromPosition(selEnd)).x - selPos.x, chrHeight)
                dlgPos, dlgSize = self.GetPosition(), self.GetSize()
                r = wx.IntersectRect(
                    wx.Rect(selPos.x, selPos.y, selSize.x, selSize.y), wx.Rect(dlgPos.x, dlgPos.y, dlgSize.x, dlgSize.y)
                )
                if r is not None:
                    ...
                    if selStartLnNo < self.view.GetFirstVisibleLine() + self.view.LinesOnScreen() / 2:
...
"""
    ...
    class PseudoStatusBar:
        def setHint(self, hint, htype="Info"):
            wx.LogMessage("Editor hint: %s" % hint)

    class PseudoEditor:
        def __init__(self):
            self.statusBar = PseudoStatusBar()

        def addBrowseMarker(self, lineNo):
            pass

        def addNewView(self, name, View):
            return createFramedView(name, View, self.model, self.parent, (400, 200))[1]

        def Disconnect(self, id):
            pass

        def setStatus(self, hint, htype="Info", ringBell=False):
            wx.LogMessage("Editor hint: %s" % hint)
    ...
    while res != wx.ID_CANCEL:
        ...
        try:
            ...
            dlg.Destroy()
        if res != wx.ID_CANCEL:
            wx.LogMessage("Reopening dialog for testing")
