...
[wxID_EDTGOTO, wxID_EDTRELOAD, wxID_EDTCLOSE, wxID_EDTCLOSEALL, wxID_EDTMOVEUP, wxID_EDTMOVEDOWN, wxID_EDTCOPYPATH] = (
    Utils.wxNewIds(7)
)
...
class OpenModelsNode(ExplorerNodes.ExplorerNode):
    ...
    def __init__(self, editor, parent):
        ExplorerNodes.ExplorerNode.__init__(self, _("Editor"), "", None, EditorHelper.imgOpenEditorModels, None, {})
        self.editor = editor
        self.bold = True
        self.vetoSort = True
...
class OpenModelItemNode(ExplorerNodes.ExplorerNode):
    ...
    def __init__(self, name, resourcepath, modulePage, parent):
        ExplorerNodes.ExplorerNode.__init__(self, name, resourcepath, None, modulePage.model.imgIdx, parent, {})
...
class ModelViewItemNode(ExplorerNodes.ExplorerNode):
    ...
    def __init__(self, name, model, parent):
        ExplorerNodes.ExplorerNode.__init__(self, name, "", None, EditorHelper.imgFolder, parent, {})
        self.model = model
...
class NewPaletteNode(ExplorerNodes.ExplorerNode):
    ...
    def __init__(self, editor, parent):
        ExplorerNodes.ExplorerNode.__init__(self, "Editor", "", None, EditorHelper.imgOpenEditorModels, None, {})
        self.editor = editor
        self.bold = True
        self.vetoSort = True
