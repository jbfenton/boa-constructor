...
def findInFiles(
    ...
    deeperPath="",
    filemask=(".htm", ".html", ".txt"),
    progressMsg="Search help files...",
    dlg=None,
    joiner="/",
):
    results = []
    ...
    if not dlg:
        dlg = wx.ProgressDialog(
            progressMsg, _("Searching..."), maxval, parent, wx.PD_CAN_ABORT | wx.PD_APP_MODAL | wx.PD_AUTO_HIDE
        )
        dlg.max = maxval
        dlg.cont = 1
        owndlg = True
