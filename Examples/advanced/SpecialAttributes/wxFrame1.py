...
class wxFrame1(wx.Frame):
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(
            ...
            name="",
            parent=prnt,
            pos=wx.Point(286, 235),
            size=wx.Size(307, 300),
        ...
        self.button1.Bind(wx.EVT_BUTTON, self.OnButton1Button, id=wxID_WXFRAME1BUTTON1)

        self.textCtrl1 = wx.TextCtrl(
            id=wxID_WXFRAME1TEXTCTRL1,
            name="textCtrl1",
            parent=self,
            pos=wx.Point(8, 8),
            size=wx.Size(280, 72),
        ...
        self.splitterWindow1 = wx.SplitterWindow(
            id=wxID_WXFRAME1SPLITTERWINDOW1,
            name="splitterWindow1",
            parent=self,
            pos=wx.Point(8, 144),
            size=wx.Size(280, 120),
            style=wx.SP_3D,
        )

        self.textCtrl2 = wx.TextCtrl(
            id=wxID_WXFRAME1TEXTCTRL2,
            name="textCtrl2",
            parent=self.splitterWindow1,
            pos=wx.Point(2, 2),
            size=wx.Size(138, 116),
            style=0,
            value="textCtrl2",
        )

        self.textCtrl3 = wx.TextCtrl(
            id=wxID_WXFRAME1TEXTCTRL3,
            name="textCtrl3",
            parent=self.splitterWindow1,
            pos=wx.Point(147, 2),
            size=wx.Size(131, 116),
            style=0,
            value="textCtrl3",
        )
