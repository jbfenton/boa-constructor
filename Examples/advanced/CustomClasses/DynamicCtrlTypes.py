...
class Frame2(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(
            ...
            name="",
            parent=prnt,
            pos=wx.Point(303, 211),
            size=wx.Size(322, 182),
            style=wx.DEFAULT_FRAME_STYLE,
            title="Frame2",
        )
        self.SetClientSize(wx.Size(314, 155))

        self.window1 = self.DynamicControl(
            id=wxID_FRAME2WINDOW1, name="window1", parent=self, pos=wx.Point(0, 0), size=wx.Size(314, 155), style=0
        )
