...
[
    ...
    wxID_FRAME1TEXTEDITOR,
] = [wx.NewIdRef() for _init_ctrls in range(3)]

[
    wxID_FRAME1MENUFILECLOSE,
    wxID_FRAME1MENUFILEEXIT,
    wxID_FRAME1MENUFILEOPEN,
    wxID_FRAME1MENUFILESAVE,
    wxID_FRAME1MENUFILESAVEAS,
...
class Frame1(wx.Frame):
    ...
    def _init_coll_menuHelp_Items(self, parent):
        ...
        parent.Append(
            helpString="Display general information about Notebook",
    ...
    def _init_coll_menuFile_Items(self, parent):
        ...
        parent.Append(helpString="Open a file", id=wxID_FRAME1MENUFILEOPEN, kind=wx.ITEM_NORMAL, item="Open")
        parent.Append(helpString="Save file", id=wxID_FRAME1MENUFILESAVE, kind=wx.ITEM_NORMAL, item="Save")
        parent.Append(helpString="Save file as", id=wxID_FRAME1MENUFILESAVEAS, kind=wx.ITEM_NORMAL, item="Save as")
        parent.Append(helpString="Close file", id=wxID_FRAME1MENUFILECLOSE, kind=wx.ITEM_NORMAL, item="Close")
        parent.Append(helpString="Close program", id=wxID_FRAME1MENUFILEEXIT, kind=wx.ITEM_NORMAL, item="Exit")
        ...
        self.Bind(wx.EVT_MENU, self.OnMenuFileCloseMenu, id=wxID_FRAME1MENUFILECLOSE)
    ...
    def _init_ctrls(self, prnt):
        ...
        self.textEditor = wx.TextCtrl(
            id=wxID_FRAME1TEXTEDITOR,
            name="textEditor",
            parent=self,
            pos=wx.Point(0, 0),
