...
class Dialog1(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(
            ...
            name="",
            parent=prnt,
            pos=wx.Point(391, 117),
            size=wx.Size(398, 330),
        ...
        self.staticText1 = wx.StaticText(
            id=wxID_DIALOG1STATICTEXT1,
            label="Note book - Simple Text Editor",
            name="staticText1",
            parent=self,
            pos=wx.Point(80, 8),
            size=wx.Size(214, 20),
        ...
        self.staticText1.SetFont(wx.Font(12, wx.SWISS, wx.NORMAL, wx.NORMAL, False, "Microsoft Sans Serif"))

        self.staticText2 = wx.StaticText(
            id=wxID_DIALOG1STATICTEXT2,
