...
[
    wxID_WXMDIPARENTFRAME1,
    wxID_WXMDIPARENTFRAME1SASHLAYOUTWINDOW1,
...
class wxMDIParentFrame1(wx.MDIParentFrame):
    ...
    def _init_coll_menu1_Items(self, parent):
        ...
        parent.Append(help="Items0", id=wxID_WXMDIPARENTFRAME1MENU1ITEMS0, kind=wx.ITEM_NORMAL, text="New child window")
        self.Bind(wx.EVT_MENU, self.OnMenu1items0Menu, id=wxID_WXMDIPARENTFRAME1MENU1ITEMS0)
    ...
    def _init_ctrls(self, prnt):
        ...
        self.sashLayoutWindow1.Bind(
            wx.EVT_SASH_DRAGGED, self.OnSashlayoutwindow1SashDragged, id=wxID_WXMDIPARENTFRAME1SASHLAYOUTWINDOW1
        )

        self.treeCtrl1 = wx.TreeCtrl(
            id=wxID_WXMDIPARENTFRAME1TREECTRL1,
            name="treeCtrl1",
