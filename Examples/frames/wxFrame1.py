...
class wxFrame1(wx.Frame):
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(
            ...
            name="",
            parent=prnt,
            pos=wx.Point(299, 227),
            size=wx.Size(370, 146),
        ...
        self.button2.Bind(wx.EVT_BUTTON, self.OnButton2Button, id=wxID_WXFRAME1BUTTON2)
        ...
        self.button3.Bind(wx.EVT_BUTTON, self.OnButton3Button, id=wxID_WXFRAME1BUTTON3)
