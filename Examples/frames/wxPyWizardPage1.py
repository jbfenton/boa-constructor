...
[
    wxID_WXPYWIZARDPAGE1,
    wxID_WXPYWIZARDPAGE1BUTTON1,
    wxID_WXPYWIZARDPAGE1BUTTON2,
    wxID_WXPYWIZARDPAGE1STATICTEXT1,
...
class wxPyWizardPage1(wx.adv.WizardPage):
    def _init_ctrls(self, prnt):
        ...
        self.staticText1 = wx.StaticText(
            id=wxID_WXPYWIZARDPAGE1STATICTEXT1,
            label="PyWizardPage1",
            name="staticText1",
            parent=self,
            pos=wx.Point(8, 8),
        ...
        self.button1.Bind(wx.EVT_BUTTON, self.OnButton1Button, id=wxID_WXPYWIZARDPAGE1BUTTON1)

        self.button2 = wx.Button(
            id=wxID_WXPYWIZARDPAGE1BUTTON2,
            label="button2",
            name="button2",
            parent=self,
            pos=wx.Point(400, 88),
