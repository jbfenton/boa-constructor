...
[
    wxID_WXWIZARD1,
    wxID_WXWIZARD1BUTTON1,
    wxID_WXWIZARD1STATICTEXT1,
...
class wxWizard1(wx.adv.Wizard):
    def _init_ctrls(self, prnt):
        ...
        wx.adv.Wizard.__init__(
            self,
            bitmap=wx.Bitmap("WizImage.png", wx.BITMAP_TYPE_PNG),
            id=wxID_WXWIZARD1,
            parent=prnt,
            pos=wx.Point(333, 205),
            title="wxWizard Example",
        )
        self.Bind(wizmod.EVT_WIZARD_PAGE_CHANGING, self.OnWxwizard1WizardPageChanging, id=wxID_WXWIZARD1)
        self.Bind(wizmod.EVT_WIZARD_PAGE_CHANGED, self.OnWxwizard1WizardPageChanged, id=wxID_WXWIZARD1)
        ...
        self.button1.Bind(wx.EVT_BUTTON, self.OnButton1Button, id=wxID_WXWIZARD1BUTTON1)

        self.staticText1 = wx.StaticText(
            id=wxID_WXWIZARD1STATICTEXT1,
            label="(status)",
            name="staticText1",
            parent=self,
            pos=wx.Point(8, 293),
