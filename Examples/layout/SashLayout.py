...
[
    ...
    wxID_FRAME1SASHLAYOUTWINDOW2,
    wxID_FRAME1SASHLAYOUTWINDOW3,
    wxID_FRAME1SASHLAYOUTWINDOW4,
...
class Frame1(wx.Frame):
    def _init_ctrls(self, prnt):
        ...
        self.sashLayoutWindow1.Bind(
            wx.EVT_SASH_DRAGGED, self.OnSashlayoutwindow1SashDragged, id=wxID_FRAME1SASHLAYOUTWINDOW1
        )

        self.sashLayoutWindow4 = wx.adv.SashLayoutWindow(
        ...
        self.sashLayoutWindow4.Bind(
            wx.EVT_SASH_DRAGGED, self.OnSashlayoutwindow4SashDragged, id=wxID_FRAME1SASHLAYOUTWINDOW4
        )

        self.sashLayoutWindow2 = wx.adv.SashLayoutWindow(
        ...
        self.sashLayoutWindow2.Bind(
            wx.EVT_SASH_DRAGGED, self.OnSashlayoutwindow2SashDragged, id=wxID_FRAME1SASHLAYOUTWINDOW2
        )

        self.sashLayoutWindow3 = wx.adv.SashLayoutWindow(
        ...
        self.sashLayoutWindow3.Bind(
            wx.EVT_SASH_DRAGGED, self.OnSashlayoutwindow3SashDragged, id=wxID_FRAME1SASHLAYOUTWINDOW3
        )
