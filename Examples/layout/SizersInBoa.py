...
class Frame1(wx.Frame):
    ...
    def _init_coll_flexGridSizer1_Items(self, parent):
        ...
        parent.AddWindow(self.button13, 0, border=10, flag=wx.ALIGN_CENTER | wx.ALL)
    ...
    def _init_coll_boxSizer2_Items(self, parent):
        ...
        parent.AddWindow(self.button19, 0, border=8, flag=wx.ALL | wx.ALIGN_CENTER)
        parent.AddSpacer(wx.Size(16, 16), border=0, flag=0)
        parent.AddWindow(self.button20, 0, border=0, flag=wx.ALIGN_CENTER)
        parent.AddSpacer(wx.Size(16, 16), border=0, flag=0)
        parent.AddWindow(self.button21, 0, border=8, flag=wx.ALL | wx.ALIGN_CENTER)

    def _init_coll_notebook1_Pages(self, parent):
        # generated method, don't edit

        parent.AddPage(imageId=-1, page=self.panel1, select=True, text="Box Sizer")
        parent.AddPage(imageId=-1, page=self.panel2, select=False, text="Grid Sizer")
        parent.AddPage(imageId=-1, page=self.panel3, select=False, text="Flex Grid Sizer")
        parent.AddPage(imageId=-1, page=self.panel4, select=False, text="StaticBox Sizer")
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(
            ...
            name="Frame1",
            parent=prnt,
            pos=wx.Point(585, 379),
            size=wx.Size(458, 307),
        ...
        self.notebook1 = wx.Notebook(
            id=wxID_FRAME1NOTEBOOK1, name="notebook1", parent=self, pos=wx.Point(0, 0), size=wx.Size(450, 280), style=0
        )
        ...
        self.button9 = wx.Button(
            id=wxID_FRAME1BUTTON9,
            label="button9",
            name="button9",
            parent=self.panel2,
            pos=wx.Point(221, 168),
            size=wx.Size(75, 23),
            style=0,
        )
        ...
        self.button10 = wx.Button(
            id=wxID_FRAME1BUTTON10,
            label="button10",
            name="button10",
            parent=self.panel3,
            pos=wx.Point(10, 10),
            size=wx.Size(232, 191),
            style=0,
        )

        self.button11 = wx.Button(
        ...
        self.button14 = wx.Button(
            id=wxID_FRAME1BUTTON14,
            label="button14",
            name="button14",
            parent=self.panel3,
            pos=wx.Point(262, 221),
            size=wx.Size(75, 23),
            style=0,
        )

        self.button15 = wx.Button(
            id=wxID_FRAME1BUTTON15,
            label="button15",
            name="button15",
            parent=self.panel3,
            pos=wx.Point(357, 221),
            size=wx.Size(75, 23),
            style=0,
        )

        self.button16 = wx.Button(
        ...
        self.button17 = wx.Button(
            id=wxID_FRAME1BUTTON17,
            label="button17",
            name="button17",
            parent=self.panel4,
            pos=wx.Point(161, 48),
            size=wx.Size(120, 170),
            style=0,
        )

        self.button18 = wx.Button(
            id=wxID_FRAME1BUTTON18,
            label="button18",
            name="button18",
            parent=self.panel4,
            pos=wx.Point(128, 218),
            size=wx.Size(185, 23),
            style=0,
        )

        self.button19 = wx.Button(
        ...
        self.button20 = wx.Button(
            id=wxID_FRAME1BUTTON20,
            label="button20",
            name="button20",
            parent=self.panel1,
            pos=wx.Point(169, 23),
        ...
        self.button21 = wx.Button(
            id=wxID_FRAME1BUTTON21,
            label="button21",
            name="button21",
            parent=self.panel1,
            pos=wx.Point(297, 40),
