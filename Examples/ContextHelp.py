...
[
    wxID_WXFRAME2,
    wxID_WXFRAME2CONTEXTHELPBUTTON1,
    wxID_WXFRAME2PANEL1,
...
class wxFrame2(wx.Frame):
    def _init_ctrls(self, prnt):
        ...
        self.contextHelpButton1 = wx.ContextHelpButton(
            parent=self.panel1, pos=wx.Point(224, 8), size=wx.Size(20, 19), style=wx.BU_AUTODRAW
        )
