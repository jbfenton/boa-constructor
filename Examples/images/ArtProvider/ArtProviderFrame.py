...
class Frame1(wx.Frame):
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(
            ...
            name="",
            parent=prnt,
            pos=wx.Point(141, 122),
            size=wx.Size(270, 155),
            style=wx.DEFAULT_FRAME_STYLE,
            title="ArtProvider Demo",
        )
        ...
        self.panel1 = wx.Panel(
            ...
            parent=self,
            pos=wx.Point(0, 0),
            size=wx.Size(262, 121),
            style=wx.TAB_TRAVERSAL,
        )

        self.bitmapButton1 = wx.BitmapButton(
            bitmap=wx.ArtProvider.GetBitmap("wxART_BOA_ICON", wx.ART_TOOLBAR, wx.DefaultSize),
        ...
        self.bitmapButton2 = wx.BitmapButton(
            bitmap=wx.ArtProvider.GetBitmap("wxART_TIP", wx.ART_TOOLBAR, wx.DefaultSize),
