...
[
    wxID_RESOURCEMODULEFRM,
    wxID_RESOURCEMODULEFRMBITMAPBUTTON,
    wxID_RESOURCEMODULEFRMLISTVIEW,
] = [wx.NewIdRef(count=1) for _init_ctrls in range(3)]

[
    wxID_RESOURCEMODULEFRMTOOLBAR1TOOLS0,
    wxID_RESOURCEMODULEFRMTOOLBAR1TOOLS1,
    wxID_RESOURCEMODULEFRMTOOLBAR1TOOLS2,
    wxID_RESOURCEMODULEFRMTOOLBAR1TOOLS3,
    wxID_RESOURCEMODULEFRMTOOLBAR1TOOLS4,
    wxID_RESOURCEMODULEFRMTOOLBAR1TOOLS5,
...
class ResourceModuleFrm(wx.Frame):
    def _init_coll_images_Images(self, parent):
        ...
        parent.Add(bitmap=Boa_img.getCollectionEditorBitmap(), mask=wx.NullBitmap)
    ...
    def _init_ctrls(self, prnt):
        ...
        self.bitmapButton.Bind(wx.EVT_BUTTON, self.OnBitmapbuttonButton, id=wxID_RESOURCEMODULEFRMBITMAPBUTTON)

        self.listView = wx.ListView(
            winid=wxID_RESOURCEMODULEFRMLISTVIEW,
            name="listView",
            parent=self,
            pos=wx.Point(148, 27),
        ...
        self.listView.Bind(
            wx.EVT_LIST_ITEM_ACTIVATED, self.OnListviewListItemActivated, id=wxID_RESOURCEMODULEFRMLISTVIEW
        )
