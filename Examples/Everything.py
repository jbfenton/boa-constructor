...
[
    wxID_FRAME1,
    wxID_FRAME1BITMAPBUTTON1,
    wxID_FRAME1BUTTON1,
    wxID_FRAME1CHECKBOX1,
    wxID_FRAME1CHECKLISTBOX1,
    wxID_FRAME1CHOICE1,
    wxID_FRAME1COMBOBOX1,
    wxID_FRAME1CONTEXTHELPBUTTON1,
    wxID_FRAME1DYNAMICSASHWINDOW1,
    wxID_FRAME1EDITABLELISTBOX1,
    wxID_FRAME1GAUGE1,
    wxID_FRAME1GENBITMAPBUTTON1,
    wxID_FRAME1GENBITMAPTEXTTOGGLEBUTTON1,
    wxID_FRAME1GENBITMAPTOGGLEBUTTON1,
    wxID_FRAME1GENBUTTON1,
    wxID_FRAME1GENTOGGLEBUTTON1,
    wxID_FRAME1GRID1,
    wxID_FRAME1HTMLWINDOW1,
    wxID_FRAME1LEDNUMBERCTRL1,
    wxID_FRAME1LISTBOX1,
    wxID_FRAME1LISTCTRL1,
    wxID_FRAME1NOTEBOOK1,
    wxID_FRAME1PANEL1,
    wxID_FRAME1PANEL2,
    wxID_FRAME1PANEL3,
    wxID_FRAME1PANEL4,
    wxID_FRAME1PANEL5,
    wxID_FRAME1PANEL6,
    wxID_FRAME1RADIOBOX1,
    wxID_FRAME1RADIOBUTTON1,
    wxID_FRAME1SASHLAYOUTWINDOW1,
    wxID_FRAME1SASHWINDOW1,
    wxID_FRAME1SCROLLBAR1,
    wxID_FRAME1SCROLLEDWINDOW1,
    wxID_FRAME1SLIDER1,
    wxID_FRAME1SPINBUTTON1,
...
class Frame1(wx.Frame):
    ...
    def _init_coll_toolBar1_Tools(self, parent):
        ...
        parent.AddTool(
            toolId=wxID_FRAME1TOOLBAR1TOOLS0,
        ...
        self.Bind(wx.EVT_TOOL, self.OnToolbar1tools0Tool, id=wxID_FRAME1TOOLBAR1TOOLS0)
    ...
    def _init_coll_notebook1_Pages(self, parent):
        ...
        parent.AddPage(imageId=-1, page=self.panel1, select=False, text="Containers/Layout")
        parent.AddPage(imageId=-1, page=self.panel2, select=False, text="Basic Controls")
        parent.AddPage(imageId=-1, page=self.panel3, select=False, text="Buttons")
        parent.AddPage(imageId=-1, page=self.panel4, select=True, text="List Controls")
        parent.AddPage(imageId=-1, page=self.panel5, select=False, text="Anchors")
    ...
    def _init_ctrls(self, prnt):
        ...
        self.toolBar1 = wx.ToolBar(
            id=wxID_FRAME1TOOLBAR1,
            name="toolBar1",
            parent=self,
            pos=wx.Point(0, 0),
            size=wx.Size(508, 27),
        ...
        self.notebook1 = wx.Notebook(
            id=wxID_FRAME1NOTEBOOK1, name="notebook1", parent=self, pos=wx.Point(0, 27), size=wx.Size(508, 383), style=0
        )
        ...
        self.sashWindow1 = wx.adv.SashWindow(
            id=wxID_FRAME1SASHWINDOW1,
            name="sashWindow1",
            parent=self.splitterWindow1,
            pos=wx.Point(107, 2),
            size=wx.Size(91, 96),
        ...
        self.splitterWindow1.SplitVertically(self.scrolledWindow1, self.sashWindow1, 100)

        self.sashLayoutWindow1 = wx.adv.SashLayoutWindow(
        ...
        self.radioButton1 = wx.RadioButton(
        ...
        self.scrollBar1 = wx.ScrollBar(
            id=wxID_FRAME1SCROLLBAR1,
            name="scrollBar1",
            parent=self.panel2,
            pos=wx.Point(16, 192),
            size=wx.Size(120, 14),
        ...
        self.htmlWindow1 = wx.html.HtmlWindow(
            id=wxID_FRAME1HTMLWINDOW1,
            name="htmlWindow1",
            parent=self.panel2,
        ...
        self.bitmapButton1.Bind(wx.EVT_BUTTON, self.OnBitmapbutton1Button, id=wxID_FRAME1BITMAPBUTTON1)
        ...
        self.spinButton1.Bind(wx.EVT_COMMAND_SCROLL, self.OnSpinbutton1CommandScroll, id=wxID_FRAME1SPINBUTTON1)

        self.toggleButton1 = wx.ToggleButton(
        ...
        self.toggleButton1.Bind(wx.EVT_BUTTON, self.OnTogglebutton1Button, id=wxID_FRAME1TOGGLEBUTTON1)

        self.genButton1 = wx.lib.buttons.GenButton(
        ...
        self.contextHelpButton1 = wx.ContextHelpButton(
            parent=self.panel3, pos=wx.Point(136, 64), size=wx.Size(20, 19), style=wx.BU_AUTODRAW
        )

        self.panel4 = wx.Panel(
            id=wxID_FRAME1PANEL4,
            name="panel4",
            parent=self.notebook1,
            pos=wx.Point(0, 0),
            size=wx.Size(500, 357),
        ...
        self.checkListBox1 = wx.CheckListBox(
            choices=[],
        ...
        self.treeCtrl1 = wx.TreeCtrl(
            id=wxID_FRAME1TREECTRL1,
            name="treeCtrl1",
            parent=self.panel4,
            pos=wx.Point(280, 56),
            size=wx.Size(100, 80),
        ...
        self.editableListBox1 = wx.adv.EditableListBox(
        ...
        self.panel5 = wx.Panel(
            id=wxID_FRAME1PANEL5,
            name="panel5",
            parent=self.notebook1,
            pos=wx.Point(0, 0),
            size=wx.Size(500, 357),
        ...
        self.window2 = wx.Window(
            id=wxID_FRAME1WINDOW2,
            name="window2",
            parent=self.panel5,
            pos=wx.Point(446, 16),
            size=wx.Size(40, 40),
        ...
        self.window2.SetConstraints(LayoutAnchors(self.window2, False, True, True, False))

        self.window3 = wx.Window(
            id=wxID_FRAME1WINDOW3,
            name="window3",
            parent=self.panel5,
            pos=wx.Point(16, 299),
            size=wx.Size(40, 40),
        ...
        self.window3.SetConstraints(LayoutAnchors(self.window3, True, False, False, True))

        self.window4 = wx.Window(
            id=wxID_FRAME1WINDOW4,
            name="window4",
            parent=self.panel5,
        ...
        self.window4.SetConstraints(LayoutAnchors(self.window4, False, False, True, True))

        self.window5 = wx.Window(
            id=wxID_FRAME1WINDOW5,
            name="window5",
            parent=self.panel5,
            pos=wx.Point(16, 16),
            size=wx.Size(40, 40),
        ...
        self.window5.SetConstraints(LayoutAnchors(self.window5, True, True, False, False))

        self.window6 = wx.Window(
            id=wxID_FRAME1WINDOW6,
            name="window6",
            parent=self.panel5,
            pos=wx.Point(192, 16),
            size=wx.Size(126, 40),
        ...
        self.window6.SetConstraints(LayoutAnchors(self.window6, True, True, True, False))

        self.window7 = wx.Window(
            id=wxID_FRAME1WINDOW7,
            name="window7",
            parent=self.panel5,
        ...
        self.window7.SetConstraints(LayoutAnchors(self.window7, False, True, True, True))

        self.window8 = wx.Window(
            id=wxID_FRAME1WINDOW8,
            name="window8",
            parent=self.panel5,
        ...
        self.window8.SetConstraints(LayoutAnchors(self.window8, True, False, True, True))

        self.window9 = wx.Window(
            id=wxID_FRAME1WINDOW9,
            name="window9",
            parent=self.panel5,
            pos=wx.Point(16, 120),
            size=wx.Size(40, 115),
        ...
        self.window9.SetConstraints(LayoutAnchors(self.window9, True, True, False, True))

        self.window10 = wx.Window(
            id=wxID_FRAME1WINDOW10,
            name="window10",
            parent=self.panel5,
        ...
        self.window10.SetConstraints(LayoutAnchors(self.window10, False, False, False, False))

        self.panel6 = wx.Panel(
            id=wxID_FRAME1PANEL6,
            name="panel6",
            parent=self.notebook1,
            pos=wx.Point(0, 0),
            size=wx.Size(500, 357),
