...
def _backupAndCopyNewestConfig(prefsFile, file, ext):
    ...
    print("Preference file %s replaced, previous version backed up to %s" % (file, bkfile))


wxPlatforms = {"__WXMSW__": "msw", "__WXGTK__": "gtk", "__WXMAC__": "mac"}
...
# thnx Mike Fletcher
screenWidth = screenHeight = wxDefaultFramePos = wxDefaultFrameSize = edWidth = inspWidth = paletteHeight = (
    bottomHeight
