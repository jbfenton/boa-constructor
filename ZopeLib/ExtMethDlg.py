...
class ExternalMethodFinder:
    ...
    def getModules(self):
        ...
        if self.prodsDir:
            ...
            for p in prods:
                if os.path.exists(os.path.join(self.prodsDir, p)) and os.path.exists(
                    os.path.join(self.prodsDir, p, "Extensions")
                ):
                    mods.extend(self._addPyMods(os.path.join(self.prodsDir, p, "Extensions"), p))
        return mods
...
[
    wxID_EXTMETHDLG,
    wxID_EXTMETHDLGBTCANCEL,
    wxID_EXTMETHDLGBTOK,
    wxID_EXTMETHDLGCBMODULE,
    wxID_EXTMETHDLGCHFUNCTION,
    wxID_EXTMETHDLGPANEL1,
    wxID_EXTMETHDLGSTATICTEXT1,
    wxID_EXTMETHDLGSTATICTEXT2,
...
class ExtMethDlg(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(
            ...
            name="ExtMethDlg",
            parent=prnt,
            pos=wx.Point(363, 248),
            size=wx.Size(267, 141),
            style=wx.DEFAULT_DIALOG_STYLE,
            title="Add External Method",
        )
        self.SetClientSize(wx.Size(259, 114))

        self.panel1 = wx.Panel(
            id=wxID_EXTMETHDLGPANEL1,
            name="panel1",
            parent=self,
            pos=wx.Point(0, 0),
            size=wx.Size(259, 114),
            style=wx.TAB_TRAVERSAL,
        )

        self.staticText1 = wx.StaticText(
            id=wxID_EXTMETHDLGSTATICTEXT1,
            label="Module:",
            name="staticText1",
            parent=self.panel1,
            pos=wx.Point(8, 16),
        ...
        self.cbModule.Bind(wx.EVT_COMBOBOX, self.OnCbmoduleCombobox, id=wxID_EXTMETHDLGCBMODULE)

        self.chFunction = wx.ComboBox(
            choices=[],
        ...
        self.chFunction.Bind(wx.EVT_COMBOBOX, self.OnChfunctionCombobox, id=wxID_EXTMETHDLGCHFUNCTION)

        self.btOK = wx.Button(
            id=wxID_EXTMETHDLGBTOK,
            label="OK",
            name="btOK",
            parent=self.panel1,
            pos=wx.Point(96, 80),
        ...
        self.btCancel.Bind(wx.EVT_BUTTON, self.OnBtcancelButton, id=wxID_EXTMETHDLGBTCANCEL)
