...
class ImageViewer(wx.MiniFrame):
    def _init_ctrls(self, prnt):
        ...
        self.sashWindow1 = wx.adv.SashWindow(
            id=wxID_IMAGEVIEWERSASHWINDOW1,
            name="sashWindow1",
            parent=self,
            pos=wx.Point(0, 0),
    ...
    def showImage(self, filename, node=None):
        ...
        try:
            ...
            return
        self.sashWindow1.SetClientSize(
            wx.Size(bmp.GetWidth() + self.borderSize * 2, bmp.GetHeight() + self.borderSize * 2)
        )
