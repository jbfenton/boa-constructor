...
[
    wxID_LANGUAGESELECTDLG,
    wxID_LANGUAGESELECTDLGBUTTON2,
    wxID_LANGUAGESELECTDLGLANGCTRLCONTAINER,
    wxID_LANGUAGESELECTDLGLANGFILTERRB,
    wxID_LANGUAGESELECTDLGOKBTN,
    wxID_LANGUAGESELECTDLGSTATICTEXT1,
...
class LanguageSelectDlg(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(
            self,
            id=wxID_LANGUAGESELECTDLG,
            name="LanguageSelectDlg",
            parent=prnt,
            pos=wx.Point(591, 400),
        ...
        self.staticText1 = wx.StaticText(
            id=wxID_LANGUAGESELECTDLGSTATICTEXT1,
            label=(
                "Choose a language that will be used for translation in the IDE.\n"
        ...
        self.langCtrlContainer = wx.Panel(
            id=wxID_LANGUAGESELECTDLGLANGCTRLCONTAINER,
            name="langCtrlContainer",
            parent=self,
            pos=wx.Point(8, 50),
            size=wx.Size(196, 142),
        ...
        self.langFilterRB = wx.RadioBox(
            choices=["Boa IDE translated languages", "Available languages on your system", "All languages"],
            ...
            parent=self,
            pos=wx.Point(212, 50),
            size=wx.Size(218, 104),
            style=wx.RA_SPECIFY_COLS,
        )
        self.langFilterRB.Bind(wx.EVT_RADIOBOX, self.OnLangFilterRBRadiobox, id=wxID_LANGUAGESELECTDLGLANGFILTERRB)
        ...
        self.okBtn = wx.Button(
            ...
            name="okBtn",
            parent=self,
            pos=wx.Point(264, 208),
            size=wx.Size(75, 23),
            style=0,
        )
        self.okBtn.Bind(wx.EVT_BUTTON, self.OnOkBtnButton, id=wxID_LANGUAGESELECTDLGOKBTN)
    ...
    def __init__(self, parent, lang=wx.LANGUAGE_DEFAULT, filter="boa", boaLangs=(wx.LANGUAGE_DEFAULT,)):
        self._init_ctrls(parent)

        self.filterMap = {
            "boa": langlistctrl.LC_ONLY,
            "available": langlistctrl.LC_AVAILABLE,
            "all": langlistctrl.LC_ALL,
        }

        self.filterIdxMap = {0: "boa", 1: "available", 2: "all"}
    ...
    def OnLangFilterRBRadiobox(self, event):
        self.langCtrl.SetUpFilter(self.filterMap[self.filterIdxMap[self.langFilterRB.GetSelection()]], self.boaLangs)
...
if __name__ == "__main__":
    # stand alone
    app = wx.App()
    dlg = LanguageSelectDlg(
        None,
        lang=wx.LANGUAGE_ENGLISH,
        boaLangs=(wx.LANGUAGE_AFRIKAANS, wx.LANGUAGE_DEFAULT, wx.LANGUAGE_ENGLISH, wx.LANGUAGE_SPANISH),
    )
    try:
    ...
    def showChooseIDELanguage(editor):
        dlg = LanguageSelectDlg(editor, lang=Preferences.i18nLanguage, boaLangs=langs)
        try:
            if dlg.ShowModal() == wx.ID_OK:
