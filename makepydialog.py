...
[
    wxID_MAKEPYDIALOG,
    wxID_MAKEPYDIALOGBFORDEMAND,
    wxID_MAKEPYDIALOGCANCEL,
    wxID_MAKEPYDIALOGDIRECTSPECIFICATION,
    wxID_MAKEPYDIALOGOK,
...
class MakePyDialog(wx.Dialog):
    def _init_coll_typeLibraryList_Columns(self, parent):
        ...
        parent.InsertColumn(col=0, format=wx.LIST_FORMAT_CENTRE, heading="Library Name", width=372)

    def _init_ctrls(self, prnt):
        # generated method, don't edit
        wx.Dialog.__init__(
            self,
            id=wxID_MAKEPYDIALOG,
            name="MakePyDialog",
            parent=prnt,
            pos=wx.Point(498, 119),
            size=wx.Size(420, 433),
        ...
        self.typeLibraryList = wx.ListCtrl(
            id=wxID_MAKEPYDIALOGTYPELIBRARYLIST,
            name="typeLibraryList",
            parent=self,
            pos=wx.Point(16, 40),
        ...
        self.typeLibraryList.Bind(wx.EVT_LEFT_DCLICK, self.OnTypelibrarylistLeftDclick)

        self.OK = wx.Button(
            id=wxID_MAKEPYDIALOGOK,
            label="Generate",
            name="OK",
            parent=self,
        ...
        self.bForDemand = wx.CheckBox(
            id=wxID_MAKEPYDIALOGBFORDEMAND,
            label="Generate Classes on Demand",
            name="bForDemand",
            parent=self,
            pos=wx.Point(144, 328),
            size=wx.Size(248, 20),
            style=0,
        )
        self.bForDemand.SetToolTip(
            "Minimises amount of code generated by only wrapping used classes (recommended).  "
            "Clear to generate a single-file wrapper."
        )
        self.bForDemand.SetValue(True)
        self.bForDemand.SetConstraints(LayoutAnchors(self.bForDemand, False, False, True, True))
        self.bForDemand.Bind(wx.EVT_CHECKBOX, self.OnBfordemandCheckbox, id=wxID_MAKEPYDIALOGBFORDEMAND)

        self.directSpecification = wx.TextCtrl(
            id=wxID_MAKEPYDIALOGDIRECTSPECIFICATION,
            name="directSpecification",
            parent=self,
            pos=wx.Point(16, 8),
            size=wx.Size(376, 28),
            style=0,
        ...
        self.directSpecification.Bind(
            wx.EVT_TEXT, self.OnDirectspecificationText, id=wxID_MAKEPYDIALOGDIRECTSPECIFICATION
        )
            ...
            for attribute in (
                ...
                for index in range(len(self.libraryList)):
                    ...
                    try:
                        ...
                        pass
        ##                    print error, librarySpecification, attribute,
        ##                          repr(getattr( librarySpecification, attribute))
        finally:
            wx.EndBusyCursor()
        return items
    ...
    def OnMakepydialogInitDialog(self, event):
        ...
        try:
            ...
            for index in range(len(libraryList)):
                ...
                self.typeLibraryList.InsertItem(index, librarySpecification.desc)
        finally:
            wx.EndBusyCursor()
